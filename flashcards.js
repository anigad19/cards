const flashcards = [
    {
        "front": "Organisms interact with their environments, exchanging matter and energy. For example, plant chloroplasts convert the energy of sunlight into A) the energy of motion B) carbon dioxide and water C) the potential energy of chemical bonds D) oxygen E) kinetic energy",
        "back": "C"
    },
    {
        "front": "The main source of energy for producers in an ecosystem is A) light energy B) kinetic energy C) thermal energy D) chemical energy E) ATP",
        "back": "A"
    },
    {
        "front": "Which of the following types of cells utilize deoxyribonucleic acid (DNA) as their genetic material but do not have their DNA encased within a nuclear envelope? A) animal B) plant C) archaea D) fungi E) protists",
        "back": "C"
    },
    {
        "front": "To understand the chemical basis of inheritance, we must understand the molecular structure of DNA. This is an example of the application of which concept to the study of biology? A) evolution B) emergent properties C) reductionism D) the cell theory E) feedback regulation",
        "back": "C"
    },
    {
    ...
    {
        "front": "Which branch of biology is concerned with the naming and classifying of organisms? A) informatics B) schematic biology C) taxonomy D) genomics E) evolution",
        "back": "C"
    },
    {
        "front": "Prokaryotic and eukaryotic cells generally have which of the following features in common? A) a membrane-bounded nucleus B) a cell wall made of cellulose C) ribosomes D) flagella or cilia that contain microtubules E) linear chromosomes made of DNA and protein",
        "back": "C"
    },
    {
        "front": "Prokaryotes are classified as belonging to two different domains. What are the domains? A) Bacteria and Eukarya B) Archaea and Monera C) Eukarya and Monera D) Bacteria and Protista E) Bacteria and Archaea",
        "back": "E"
    },
    {
    ...
    {
        "front": "A water sample from a hot thermal vent contained a single-celled organism that had a cell wall but lacked a nucleus. What is its most likely classification? A) Eukarya B) Archaea C) Animalia D) Protista E) Fungi",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of these provides evidence of the common ancestry of all life? A) ubiquitous use of catalysts by living systems B) near universality of the genetic code C) structure of the nucleus D) structure of cilia E) structure of chloroplasts",
        "back": "B"
    },
    {
    ...
    {
        "front": "Darwin's finches, collected from the Gal\u00e1pagos Islands, illustrate which of the following? A) mutation frequency B) ancestors from different regions C) adaptive radiation D) vestigial anatomic structures E) the accuracy of the fossil record",
        "back": "C"
    },
    {
        "front": "Which of the following categories of organisms is least likely to be revised? A) kingdom B) class C) order D) phylum E) species",
        "back": "E"
    },
    {
        "front": "What is the major distinguishing characteristic of fungi? A) gaining nutrition through ingestion B) being sedentary C) being prokaryotic D) absorbing dissolved nutrients E) being decomposers of dead organisms",
        "back": "D"
    },
    {
    ...
    {
        "front": "The method of scientific inquiry that describes natural structures and processes as accurately as possible through careful observation and the analysis of data is known as A) hypothesis-based science. B) discovery science. C) experimental science. D) quantitative science. E) qualitative science.",
        "back": "B"
    },
    {
    ...
    {
        "front": "When applying the process of science, which of these is tested? A) a question B) a result C) an observation D) a prediction E) a hypothesis",
        "back": "D"
    },
    {
    ...
    {
        "front": "The application of scientific knowledge for some specific purpose is known as A) technology. B) deductive science. C) inductive science. D) anthropologic science. E) pure science.",
        "back": "A"
    },
    {
        "front": "Which of the following are qualities of any good scientific hypothesis? I. It is testable. II. It is falsifiable. III. It produces quantitative data. IV. It produces results that can be replicated. A) I only B) II only C) III only D) I and II E) III and IV",
        "back": "D"
    },
    {
        "front": "When a hypothesis cannot be written in an \"If\u2026then\" format, what does this mean? A) It does not represent deductive reasoning. B) It cannot be a scientific hypothesis. C) The subject cannot be explored scientifically. D) The hypothesizer does not have sufficient information. E) It cannot be testable.",
        "back": "A"
    },
    {
    ...
    {
        "front": "What do these two plants have in common? A) adaptations to extreme heat B) adaptations to conserve water C) identical stem structures D) identical flower structures E) lack of photosynthesis",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which theme(s) is/are best illustrated by a group of investigators who are trying to classify and explain the ecology of an area known as the Big Thicket? A) I only B) II only C) VIII only D) IV and VI E) I and II",
        "back": "E"
    },
    {
        "front": "Which theme(s) is/are illustrated when a group of students is trying to establish which phase of cell division in root tips happens most quickly? A) IV only B) V only C) VII only D) IV, V, and VI E) V, VI, and VII",
        "back": "D"
    },
    {
        "front": "Which theme(s) is/are illustrated when a biology class is comparing the rates of photosynthesis between leaves of a flowering plant species (Gerbera jamesonii) and a species of fern (Polypodium polypodioides)? A) I only B) II only C) I and III D) I and VII E) I, III, and V",
        "back": "E"
    },
    {
        "front": "Questions 55 - 64 are from the end-of-chapter \"Test Your Understanding\" section in Chapter 1 of the textbook.  All the organisms on your campus make up A) an ecosystem. B) a community. C) a population. D) an experimental group. E) a taxonomic domain.",
        "back": "B"
    },
    {
    ...
    {
        "front": "Protists and bacteria are grouped into different domains because A) protists eat bacteria. B) bacteria are not made of cells. C) protists have a membrane-bounded nucleus, which bacterial cells lack. D) bacteria decompose protists. E) protists are photosynthetic.",
        "back": "C"
    },
    {
        "front": "Which of the following best demonstrates the unity among all organisms? A) matching DNA nucleotide sequences B) descent with modification C) the structure and function of DNA D) natural selection E) emergent properties",
        "back": "C"
    },
    {
    ...
    {
        "front": "4) The proximate causes of behavior are interactions with the environment, but behavior is ultimately shaped by A) hormones. B) evolution. C) sexuality. D) pheromones. E) the nervous system.",
        "back": "B"
    },
    {
        "front": "5) Animal communication involves what type of sensory information? A) visual B) auditory C) olfactory D) tactile E) visual, auditory, olfactory, and tactile",
        "back": "E"
    },
    {
        "front": "6) What type of signal is long-lasting and works at night? A) olfactory B) visual C) auditory D) tactile E) electrical",
        "back": "A"
    },
    {
        "front": "7) What type of signal is brief and can work among obstructions at night? A) olfactory B) visual C) auditory D) tactile E) magnetic",
        "back": "C"
    },
    {
        "front": "8) What type of signal is fast and requires daylight with no obstructions? A) olfactory B) visual C) auditory D) tactile E) electrical",
        "back": "B"
    },
    {
        "front": "9) A chemical produced by an animal that serves as a communication to another animal of the same species is called A) a sign stimulus. B) an inducer. C) a pheromone. D) an imprinter. E) an agonistic promoter.",
        "back": "C"
    },
    {
        "front": "10) Research has shown that nocturnal animals navigate using A) olfactory cues. B) the North Star. C) the moon. D) landmarks. E) gravity.",
        "back": "B"
    },
    {
        "front": "11) Circannual rhythms in birds are influenced by A) periods of food availability. B) reproductive readiness. C) periods of daylight and darkness. D) magnetic fields. E) lunar cycles.",
        "back": "C"
    },
    {
        "front": "12) Upon returning to its hive, a European honeybee communicates to other worker bees the location of a nearby food source it has discovered by A) vibrating its wings at varying frequencies. B) performing a round dance. C) performing a waggle dance. D) visual cues. E) All options are correct.",
        "back": "B"
    },
    {
    ...
    {
        "front": "14) Animals use pheromones to communicate A) reproductive readiness. B) species recognition. C) gender recognition. D) danger. E) All options are correct.",
        "back": "E"
    },
    {
        "front": "15) Displays of nocturnal mammals are usually A) visual and auditory. B) tactile and visual. C) olfactory and auditory. D) visual and olfactory. E) tactile and auditory.",
        "back": "C"
    },
    {
    ...
    {
        "front": "21) If mayflies lay eggs on roads instead of in water, it would indicate which of the following? A) a defective gene B) trial-and-error learning C) a misdirected response to a sign stimulus D) a natural behavioral variation in the mayfly population E) aberrant behavior due to insecticide poisoning",
        "back": "C"
    },
    {
    ...
    {
        "front": "23) A type of learning that can occur only during a brief period of early life and results in a behavior that is difficult to modify through later experiences is called A) insight. B) imprinting. C) habituation. D) operant conditioning. E) trial-and-error learning.",
        "back": "B"
    },
    {
        "front": "24) Learning in which an associated stimulus may be used to elicit the same behavioral response as the original sign stimulus is called A) concept formation. B) trial and error. C) classical conditioning. D) operant conditioning. E) cognition.",
        "back": "C"
    },
    {
        "front": "25) Every morning at the same time, John went into the den to feed his new tropical fish. After a few weeks, he noticed that the fish swam to the top of the tank when he entered the room. This is an example of A) cognition. B) imprinting. C) classical conditioning. D) operant conditioning. E) maturation.",
        "back": "C"
    },
    {
        "front": "26) A type of bird similar to a chickadee learns to peck through the cardboard tops of milk bottles left on doorsteps to obtain the desired cream from the top. What term best applies to this behavior? A) sign stimulus B) cognition C) imprinting D) classical conditioning E) operant conditioning",
        "back": "E"
    },
    {
        "front": "27) A salmon returns to its home stream to spawn. What term best applies to this behavior? A) sign stimulus B) cognition C) imprinting D) classical conditioning E) operant conditioning",
        "back": "C"
    },
    {
        "front": "28) A stickleback fish will attack a fish model as long as the model has red coloring. What animal behavior idea is manifested by this observation? A) sign stimulus B) cognition C) imprinting D) classical conditioning E) operant conditioning",
        "back": "A"
    },
    {
        "front": "29) Parental protective behavior in turkeys is triggered by the cheeping sound of young chicks. What term best applies to this behavior? A) sign stimulus B) cognition C) imprinting D) classical conditioning E) operant conditioning",
        "back": "A"
    },
    {
        "front": "30) A guinea pig loves the lettuce kept in the refrigerator and squeals each time the refrigerator door opens. What term best applies to this behavior? A) sign stimulus B) cognition C) imprinting D) classical conditioning E) operant conditioning",
        "back": "D"
    },
    {
    ...
    {
        "front": "33) Among songbirds, a \"crystallized\" song is one that A) is beyond the range of human hearing. B) is perfected by juveniles. C) extremely young chicks sing. D) is a perfected species-specific song. E) warns of predators.",
        "back": "D"
    },
    {
        "front": "34) What is the normal imprinting stimulus to a hatchling graylag goose? A) an image of a model of an adult graylag goose B) a nearby object that is moving away C) recognition of its biological mother D) any other adult of its own species E) any human",
        "back": "B"
    },
    {
    ...
    {
        "front": "41) Feeding behavior with a high energy intake-to-expenditure ratio is called A) herbivory. B) autotrophy. C) heterotrophy. D) search scavenging. E) optimal foraging.",
        "back": "E"
    },
    {
    ...
    {
        "front": "43) Which of the following might affect the foraging behavior of an animal in the context of optimal foraging? A) risk of predation B) prey size C) prey defenses D) prey density E) All of the options are correct.",
        "back": "E"
    },
    {
        "front": "44) You discover a rare new bird species, but you are unable to observe its mating behavior. You see that the male is large and ornamental compared with the female. On this basis, you can probably conclude that the species is A) polygamous. B) monogamous. C) polyandrous. D) promiscuous. E) agonistic.",
        "back": "A"
    },
    {
        "front": "45) The evolution of mating systems is most likely affected by A) population density. B) territoriality. C) certainty of paternity. D) sexual dimorphism. E) None of the options is correct.",
        "back": "D"
    },
    {
        "front": "46) The mating system in which females are more ornamented than males is A) monogamy. B) promiscuity. C) polygamy. D) polygyny. E) polyandry.",
        "back": "E"
    },
    {
    ...
    {
        "front": "54) Which of the following does not have a coefficient of relatedness of 0.5? A) a father to his daughter B) a mother to her son C) an uncle to his nephew D) a brother to his brother E) a sister to her brother",
        "back": "C"
    },
    {
        "front": "55) Animals that help other animals of the same species A) have excess energy reserves. B) are bigger and stronger than the other animals. C) are usually related to the other animals. D) are always male. E) have defective genes controlling their behavior.",
        "back": "C"
    },
    {
    ...
    {
        "front": "59) In the territorial behavior of the stickleback fish, the red belly of one male that elicits attack from another male is functioning as A) a pheromone. B) a sign stimulus. C) a fixed action pattern. D) a search image. E) an imprint stimulus.",
        "back": "B"
    },
    {
    ...
    {
        "front": "5) Which of the following choices includes all of the others in creating global terrestrial climates? A) differential heating of Earth's surface B) ocean currents C) global wind patterns D) evaporation of water from ocean surfaces E) Earth's rotation on its axis",
        "back": "A"
    },
    {
    ...
    {
        "front": "10) Which of the following abiotic factors has the greatest influence on the metabolic rates of plants and animals? A) water B) wind C) temperature D) rocks and soil E) disturbances",
        "back": "C"
    },
    {
    ...
    {
        "front": "16) Which of the following environmental features might influence microclimates? A) forest canopy B) freshly plowed field C) log on the forest floor D) large boulder E) All of the options are correct.",
        "back": "E"
    },
    {
        "front": "17) The success with which plants extend their range northward following glacial retreat is best determined by A) whether there is simultaneous migration of herbivores. B) their tolerance to shade. C) their seed dispersal rate. D) their size. E) their growth rate.",
        "back": "C"
    },
    {
    ...
    {
        "front": "21) If global warming continues at its present rate, which biomes will likely take the place of the coniferous forest (taiga)? A) tundra and polar ice B) temperate broadleaf forest and grassland C) desert and chaparral D) tropical forest and savanna E) chaparral and temperate broadleaf forest",
        "back": "B"
    },
    {
        "front": "22) Which of the following are important biotic factors that can affect the structure and organization of biological communities? A) precipitation, wind B) nutrient availability, soil pH C) predation, competition D) temperature, water E) light intensity, seasonality",
        "back": "C"
    },
    {
    ...
    {
        "front": "24) Coral reefs can be found on the southern east coast of the United States but not at similar latitudes on the southern west coast. Differences in which of the following most likely account for this? A) sunlight intensity B) precipitation C) day length D) ocean currents E) salinity",
        "back": "D"
    },
    {
    ...
    {
        "front": "27) What is the limiting factor for the growth of trees in the tundra? A) low precipitation B) cold temperatures C) insufficient minerals in bedrock D) pH of soils E) permafrost",
        "back": "E"
    },
    {
        "front": "28) Generally speaking, deserts are located in places where air masses are usually A) tropical. B) humid. C) rising. D) descending. E) expanding.",
        "back": "D"
    },
    {
    ...
    {
        "front": "30) In temperate lakes, the surface water is replenished with nutrients during turnovers that occur in the A) autumn and spring. B) autumn and winter. C) spring and summer. D) summer and winter. E) summer and autumn.",
        "back": "A"
    },
    {
    ...
    {
        "front": "33) Which marine zone would have the lowest rates of primary productivity (photosynthesis)? A) pelagic B) abyssal C) neritic D) continental shelf E) intertidal",
        "back": "B"
    },
    {
        "front": "34) If you are interested in observing a relatively simple community structure in a clear water lake, you would do well to choose diving into A) an oligotrophic lake. B) a eutrophic lake. C) a relatively shallow lake. D) a nutrient-rich lake. E) a lake with consistently warm temperatures.",
        "back": "A"
    },
    {
    ...
    {
        "front": "36) If a meteor impact or volcanic eruption injected a lot of dust into the atmosphere and reduced the sunlight reaching Earth's surface by 70% for one year, which of the following marine communities most likely would be least affected? A) deep-sea vent B) coral reef C) intertidal D) pelagic E) estuary",
        "back": "A"
    },
    {
    ...
    {
        "front": "41) In the development of terrestrial biomes, which factor is most dependent on all the others? A) the species of colonizing animals B) prevailing temperature C) prevailing rainfall D) mineral nutrient availability E) soil structure",
        "back": "A"
    },
    {
        "front": "42) Two plant species live in the same biome but on different continents. Although the two species are not at all closely related, they may appear quite similar as a result of A) parallel evolution. B) convergent evolution. C) allopatric speciation. D) introgression. E) gene flow.",
        "back": "B"
    },
    {
        "front": "43) In which of the following terrestrial biome pairs are both parts dependent upon periodic burning? A) tundra and coniferous forest B) chaparral and savanna C) desert and savanna D) tropical forest and temperate broadleaf forest E) grassland and tundra",
        "back": "B"
    },
    {
    ...
    {
        "front": "46) In which community would organisms most likely have adaptations enabling them to respond to different photoperiods? A) tropical forest B) coral reef C) savanna D) temperate forest E) abyssal",
        "back": "D"
    },
    {
        "front": "47) The growing season would generally be shortest in which of the following biomes? A) savanna B) temperate broadleaf forest C) temperate grassland D) tropical rain forest E) coniferous forest",
        "back": "E"
    },
    {
        "front": "48) Trees are not usually found in the tundra biome because of A) insufficient annual precipitation. B) acidic soils. C) extreme winter temperatures. D) overbrowsing by musk ox and caribou. E) permafrost.",
        "back": "E"
    },
    {
    ...
    {
        "front": "The diagram shows a generalized cross section of the marine environment with various zones labeled with letters. Choose the letter that best answers the question. Letters may be used once, more than once, or not at all  56) Which zone has a condition of constant temperature? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "The diagram shows a generalized cross section of the marine environment with various zones labeled with letters. Choose the letter that best answers the question. Letters may be used once, more than once, or not at all  57) Which zone produces the most global oxygen gas? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
    ...
    {
        "front": "The diagram shows a generalized cross section of the marine environment with various zones labeled with letters. Choose the letter that best answers the question. Letters may be used once, more than once, or not at all  59) Which zone has the lowest biomass per unit of area? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
    ...
    {
        "front": "64) Which of the following areas of study focuses on the exchange of energy, organisms, and materials between ecosystems? A) population ecology B) organismal ecology C) landscape ecology D) ecosystem ecology E) community ecology",
        "back": "C"
    },
    {
        "front": "65) Which lake zone would be absent in a very shallow lake? A) benthic zone B) aphotic zone C) pelagic zone D) littoral zone E) limnetic zone",
        "back": "B"
    },
    {
    ...
    {
        "front": "68) Which of the following is characteristic of most terrestrial biomes? A) annual average rainfall in excess of 250 cm B) a distribution predicted almost entirely by rock and soil patterns C) clear boundaries between adjacent biomes D) vegetation demonstrating vertical layering E) cold winter months",
        "back": "D"
    },
    {
    ...
    {
        "front": "73) If the direction of Earth's rotation reversed, the most predictable effect would be A) no more night and day. B) a big change in the length of the year. C) winds blowing from west to east along the equator. D) a loss of seasonal variation at high latitudes. E) the elimination of ocean currents.",
        "back": "C"
    },
    {
    ...
    {
        "front": "2) A population is correctly defined as having which of the following characteristics?  I. inhabiting the same general area II. belonging to the same species III. possessing a constant and uniform density and dispersion  A) I only B) III only C) I and II only D) II and III only E) I, II, and III",
        "back": "C"
    },
    {
        "front": "3) An ecologist recorded 12 white-tailed deer, Odocoileus virginianus, per square mile in one woodlot and 20 per square mile in another woodlot. What was the ecologist comparing? A) density B) dispersion C) carrying capacity D) cohorts E) range",
        "back": "A"
    },
    {
    ...
    {
        "front": "19) Exponential growth of a population is represented by dN/dt =  A. SEE IMAGE B. SEE IMAGE C. SEE IMAGE D. SEE IMAGE E. SEE IMAGE",
        "back": "B"
    },
    {
        "front": "20) Starting from a single individual, what is the size of a population of bacteria that reproduce by binary fission every 20 minutes at the end of a 2-hour time period? (Assume unlimited resources and no mortality.) A) 6 B) 18 C) 128 D) 512 E) 1,024",
        "back": "D"
    },
    {
        "front": "21) Which of the following is the equation for zero population growth (ZPG)? A) R = b - m B) dN/dt = rN C) dN/dt =rmax N (K -N)/K D) dN/dt =rmax N E) dN/dt = 1.0N",
        "back": "A"
    },
    {
        "front": "22) In July 2008, the United States had a population of approximately 302,000,000 people. How many Americans were there in July 2009, if the estimated 2008 growth rate was 0.88%? A) 2,700,000 B) 5,500,000 C) 303,000,000 D) 304,000,000 E) 2,710,800,000",
        "back": "D"
    },
    {
        "front": "23) In 2008, the population of New Zealand was approximately 4,275,000 people. If the birth rate was 14 births for every 1,000 people, approximately how many births occurred in New Zealand in 2008? A) 6,000 B) 42,275 C) 60,000 D) 140,000 E) 600,000",
        "back": "C"
    },
    {
    ...
    {
        "front": "25) Logistic growth of a population is represented by dN/dt =  A. SEE IMAGE B. SEE IMAGE C. SEE IMAGE D. SEE IMAGE E. SEE IMAGE",
        "back": "D"
    },
    {
    ...
    {
        "front": "30) Which of the following causes populations to shift most quickly from an exponential to a logistic population growth? A) increased birth rate B) removal of predators C) decreased death rate D) competition for resources E) favorable climatic conditions",
        "back": "D"
    },
    {
    ...
    {
        "front": "35) Pacific salmon and annual plants are excellent examples of A) cohort disintegration. B) dispersion. C) Allee effect. D) iteroparous reproduction. E) semelparous reproduction.",
        "back": "E"
    },
    {
        "front": "36) Which of the following is characteristic of K-selected populations? A) offspring with good chances of survival B) many offspring per reproductive episode C) small offspring D) a high intrinsic rate of increase E) early parental reproduction",
        "back": "A"
    },
    {
    ...
    {
        "front": "38) Which pattern of reproduction is correctly paired with a species? A) iteroparityPacific salmon B) iteroparityelephant C) semelparityoak tree D) semelparityrabbit E) semelparity\u2013polar bear",
        "back": "B"
    },
    {
    ...
    {
        "front": "41) Which of the following is most likely to contribute to density-dependent regulation of populations? A) the removal of toxic waste by decomposers B) intraspecific competition for nutrients C) earthquakes D) floods E) fires",
        "back": "B"
    },
    {
    ...
    {
        "front": "45) Which of the following could be a density-independent factor limiting human population growth? A) social pressure for birth control B) earthquakes C) plagues D) famines E) pollution",
        "back": "B"
    },
    {
    ...
    {
        "front": "47) Which of the following was the most significant limiting factor in human population growth in the 20th century? A) famine B) non-HIV disease C) HIV D) genocide E) clean water",
        "back": "E"
    },
    {
        "front": "48) Which of the following is most key to understanding the demographic transition in human population growth? A) education of global famine B) improved worldwide health care C) voluntary reduction of family size D) improved sanitary conditions in the world's hospitals E) reduction of casualties of war",
        "back": "C"
    },
    {
        "front": "49) Why does the 2009 U.S. population continue to grow even though the United States has essentially established a ZPG? A) emigration B) immigration C) better sanitation D) baby boomer reproduction E) the 2007-2009 economic recession",
        "back": "B"
    },
    {
    ...
    {
        "front": "51) Which curve best describes survivorship in marine molluscs? A) A B) B C) C D) D E) E",
        "back": "E"
    },
    {
        "front": "52) Which curve best describes survivorship in elephants? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
        "front": "53) Which curve best describes survivorship in a marine crustacean that molts? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
        "front": "54) Which curve best describes survivorship in humans who live in undeveloped nations? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
    ...
    {
        "front": "56) Which of the following graphs illustrates the population growth curve of single bacterium growing in a flask of ideal medium at optimum temperature over a 24-hour period?  A. SEE IMAGE B. SEE IMAGE C. SEE IMAGE D. SEE IMAGE E. SEE IMAGE",
        "back": "C"
    },
    {
        "front": "57) Which of the following graphs illustrates the growth curve of a small population of rodents that has grown to reach a static carrying capacity?",
        "back": "E"
    },
    {
        "front": "Please read the paragraph below and review Figure 53.2 to answer the following question.  Researchers in the Netherlands studied the effects of parental care given in European kestrels over five years. The researchers transferred chicks among nests to produce reduced broods (three or four chicks), normal broods (five or six chicks), and enlarged broods (seven or eight chicks). They then measured the percentage of male and female parent birds that survived the following winter. (Both males and females provide care for chicks.)  Figure 53.2: Brood size manipulations in the kestrel: Effects on offspring and parent survival.  58) Which of the following is a conclusion that can be drawn from this graph? A) Female survivability is more negatively affected by larger brood size than is male survivability. B) Male survivability decreased by 50% between reduced and enlarged brood treatments. C) Both males and females had increases in daily hunting with the enlarged brood size. D) There appears to be a negative correlation between brood enlargements and parental survival. E) Chicks in reduced brood treatment received more food, weight gain, and reduced mortality.",
    ...
    {
        "front": "59) Which of the following is a likely graphic outcome of a population of deer introduced to an island with an adequate herbivory and without natural predators, parasites, or disease?  A. SEE IMAGE B. SEE IMAGE C. SEE IMAGE D. SEE IMAGE E. SEE IMAGE",
        "back": "A"
    },
    {
        "front": "60) Which of the following graphs illustrates the growth over several seasons of a population of snowshoe hares that were introduced to an appropriate habitat also inhabited by predators in northern Canada?",
        "back": "D"
    },
    {
        "front": "The following questions refer to Figure 53.3, which depicts the age structure of three populations.  61) Which population(s) is (are) in the process of decreasing? A) I B) II C) III D) I and II E) II and III",
        "back": "B"
    },
    {
        "front": "The following questions refer to Figure 53.3, which depicts the age structure of three populations.  62) Which population(s) appear(s) to be stable? A) I B) II C) III D) I and II E) II and III",
        "back": "C"
    },
    {
    ...
    {
        "front": "The following questions refer to Figure 53.3, which depicts the age structure of three populations.  64) Assuming these age-structure diagrams describe human populations, which population(s) is (are) likely to experience zero population growth (ZPG)? A) I B) II C) III D) I and II E) II and III",
        "back": "C"
    },
    {
    ...
    {
        "front": "71) A population's carrying capacity A) may change as environmental conditions change. B) can be accurately calculated using the logistic growth model. C) generally remains constant over time. D) increases as the per capita growth rate (r) decreases. E) can never be exceeded.",
        "back": "A"
    },
    {
    ...
    {
        "front": "73) Based on current growth rates, Earth's human population in 2012 will be closest to A) 2 million. B) 3 billion. C) 4 billion. D) 7 billion. E) 10 billion.",
        "back": "D"
    },
    {
    ...
    {
        "front": "77) Which pair of terms most accurately describes life history traits for a stable population of wolves? A) semelparous; r-selected B) semelparous; K-selected C) iteroparous; r-selected D) iteroparous; K-selected E) iteroparous; N-selected",
        "back": "D"
    },
    {
        "front": "78) During exponential growth, a population always A) grows by thousands of individuals. B) grows at its maximum per capita rate. C) quickly reaches its carrying capacity. D) cycles through time. E) loses some individuals to emigration.",
        "back": "B"
    },
    {
    ...
    {
        "front": "2) According to the competitive exclusion principle, two species cannot continue to occupy the same A) habitat. B) niche. C) territory. D) range. E) biome.",
        "back": "B"
    },
    {
    ...
    {
        "front": "6) Which of the following is an example of cryptic coloration? A) bands on a coral snake B) brown or gray color of tree bark C) markings of a viceroy butterfly's wings D) colors of an insect-pollinated flower's petals E) a \"walking stick\" insect that resembles a twig",
        "back": "E"
    },
    {
    ...
    {
        "front": "9) Which of the following is an example of aposematic coloration? A) stripes of a skunk B) eye color in humans C) green color of a plant D) colors of an insect-pollinated flower E) a katydid whose wings look like a dead leaf",
        "back": "A"
    },
    {
    ...
    {
        "front": "11) Evidence shows that some grasses benefit from being grazed. Which of the following terms would best describe this plant-herbivore interaction? A) mutualism B) commensalism C) parasitism D) competition E) predation",
        "back": "A"
    },
    {
    ...
    {
        "front": "19) What percent of all species on Earth are parasites? A) 1% B) 5% C) 25% D) 33 1/3% E) 50%",
        "back": "D"
    },
    {
        "front": "20) Which of the following terms is used by ecologists to describe the community interaction where one organism makes the environment more suitable for another organism? A) parasitism B) mutualism C) inhibition D) facilitation E) commensalism",
        "back": "D"
    },
    {
    ...
    {
        "front": "22) Approximately how many kg of carnivore biomass can be supported by a field plot containing 1,000 kg of plant material? A) 10,000 B) 1,000 C) 100 D) 10 E) 1",
        "back": "D"
    },
    {
        "front": "23) The energetic hypothesis and dynamic stability hypothesis are ideas that attempt to explain A) plant defenses against herbivores. B) the length of food chains. C) the evolution of mutualism. D) resource partitioning. E) competitive exclusion.",
        "back": "B"
    },
    {
        "front": "24) In a tide pool, 15 species of invertebrates were reduced to eight after one species was removed. The species removed was likely a(n) A) pathogen. B) keystone species. C) herbivore. D) resource partitioner. E) mutualistic organism.",
        "back": "B"
    },
    {
    ...
    {
        "front": "26) According to bottom-up and top-down control models of community organization, which of the following expressions would imply that an increase in the size of a carnivore (C) population would negatively impact on its prey (P) population, but not vice versa? A) P \u2190 C B) P \u2192 C C) C \u2194 P D) P \u2190 C \u2192 P E) C \u2190 P \u2192 C",
        "back": "A"
    },
    {
    ...
    {
        "front": "29) Imagine five forest communities, each with 100 individuals distributed among four different tree species (W, X, Y, and Z). Which forest community would be most diverse? A) 25W, 25X, 25Y, 25Z B) 40W, 30X, 20Y, 10Z C) 50W, 25X, 15Y, 10Z D) 70W, 10X, 10Y, 10Z E) 100W, 0X, 0Y, 0Z",
        "back": "A"
    },
    {
    ...
    {
        "front": "31) Which term do ecologists use to describe the ability of a community either to resist change or to recover to its original state after change? A) stability B) succession C) partitioning D) productivity E) competitive exclusion",
        "back": "A"
    },
    {
    ...
    {
        "front": "33) In a particular case of secondary succession, three species of wild grass all invaded a field. By the second season, a single species dominated the field. A possible factor in this secondary succession was A) equilibrium. B) facilitation. C) immigration. D) inhibition. E) parasitism.",
        "back": "D"
    },
    {
        "front": "34) The 1988 Yellowstone National Park lodgepole pine forest fires were likely the result of A) overgrazing by elk. B) infrequent rain episodes. C) years of fire suppression by humans. D) unextinguished campfires. E) geysers.",
        "back": "C"
    },
    {
    ...
    {
        "front": "36) Species richness increases A) as we increase in altitude in equatorial mountains. B) as we travel southward from the North Pole. C) on islands as distance from the mainland increases. D) as depth increases in aquatic communities. E) as community size decreases.",
        "back": "B"
    },
    {
    ...
    {
        "front": "38) A community's actual evapotranspiration is a reflection of A) solar radiation, temperature, and water availability. B) the number of plants and how much moisture they lose. C) the depth of the water table. D) wind speed and the frequency of wind gusts. E) plant biomass and plant water content.",
        "back": "A"
    },
    {
    ...
    {
        "front": "43) Of the following zoonotic diseases, which is most likely to be studied by a community ecologist? A) mad cow disease B) hantavirus C) AIDS D) avian flu E) trichinosis",
        "back": "D"
    },
    {
    ...
    {
        "front": "51) According to the Shannon Diversity Index, which block would show the greatest diversity? A) 1 B) 2 C) 3 D) 4 E) 5",
        "back": "E"
    },
    {
        "front": "Use the following diagram of a hypothetical food web to answer the following question. The arrows represent the transfer of food energy between the various trophic levels.  Figure 54.3  52) Which letter represents an organism that could be a carnivore? A) A B) B C) C D) D E) E",
        "back": "E"
    },
    {
        "front": "Use the following diagram of a hypothetical food web to answer the following question. The arrows represent the transfer of food energy between the various trophic levels.  Figure 54.3  53) Which letter represents an organism that could be a producer? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
        "front": "Use the following diagram of a hypothetical food web to answer the following question. The arrows represent the transfer of food energy between the various trophic levels.  Figure 54.3  54) Which letter represents an organism that could be a primary consumer? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "Use the following diagram of five islands formed at around the same time near a particular mainland, as well as MacArthur and Wilson's island biogeography principles, to answer the following question.  Figure 54.4  55) Which island would likely have the greatest species diversity? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
    ...
    {
        "front": "Use the following diagram of five islands formed at around the same time near a particular mainland, as well as MacArthur and Wilson's island biogeography principles, to answer the following question.  Figure 54.4  57) Which island would likely have the lowest extinction rate? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
    ...
    {
        "front": "70) The feeding relationships among the species in a community determine the community's A) secondary succession. B) ecological niche. C) species richness. D) species-area curve. E) trophic structure.",
        "back": "E"
    },
    {
    ...
    {
        "front": "72) Based on the intermediate disturbance hypothesis, a community's species diversity is increased by A) frequent massive disturbance. B) stable conditions with no disturbance. C) moderate levels of disturbance. D) human intervention to eliminate disturbance. E) intensive disturbance by humans.",
        "back": "C"
    },
    {
        "front": "73) According to the equilibrium model of island biogeography, species richness would be greatest on an island that is A) large and close to a mainland. B) large and remote. C) small and remote. D) small and close to a mainland. E) environmentally homogeneous.",
        "back": "A"
    },
    {
    ...
    {
        "front": "1) How do the Taylor Glacier bacteria produce their energy? A) photosynthesis B) heterotrophism C) chemoautotrophism D) thermophobism E) chemosynthesis",
        "back": "C"
    },
    {
    ...
    {
        "front": "6) A cow's herbivorous diet indicates that it is a(n) A) primary consumer. B) secondary consumer. C) decomposer. D) autotroph. E) producer.",
        "back": "A"
    },
    {
        "front": "7) To recycle nutrients, an ecosystem must have, at a minimum, A) producers. B) producers and decomposers. C) producers, primary consumers, and decomposers. D) producers, primary consumers, secondary consumers, and decomposers. E) producers, primary consumers, secondary consumers, top carnivores, and decomposers.",
        "back": "B"
    },
    {
        "front": "8) Which of the following terms encompasses all of the others? A) heterotrophs B) herbivores C) carnivores D) primary consumers E) secondary consumers",
        "back": "A"
    },
    {
    ...
    {
        "front": "11) If the sun were to suddenly stop providing energy to Earth, most ecosystems would vanish. Which of the following ecosystems would likely survive the longest after this hypothetical disaster? A) tropical rain forest B) tundra C) benthic ocean D) grassland E) desert",
        "back": "C"
    },
    {
    ...
    {
        "front": "15) What percentage of solar radiation striking a plant is converted into chemical energy? A) 1% B) 10% C) 25% D) 50% E) 100%",
        "back": "A"
    },
    {
    ...
    {
        "front": "17) Which of these ecosystems accounts for the largest amount of Earth's net primary productivity? A) tundra B) savanna C) salt marsh D) open ocean E) tropical rain forest",
        "back": "D"
    },
    {
        "front": "18) Which of these ecosystems has the highest net primary productivity per square meter? A) savanna B) open ocean C) boreal forest D) tropical rain forest E) temperate forest",
        "back": "D"
    },
    {
        "front": "19) Which data is most useful to measure primary productivity in a terrestrial ecosystem? A) temperature readings B) potential evapotranspiration C) intensity of solar radiation D) annual precipitation E) amount of carbon fixed",
        "back": "D"
    },
    {
    ...
    {
        "front": "21) The total biomass of photosynthetic autotrophs present in an ecosystem is known as A) gross primary productivity. B) standing crop. C) net primary productivity. D) secondary productivity. E) trophic efficiency.",
        "back": "B"
    },
    {
    ...
    {
        "front": "25) Aquatic primary productivity is most limited by which of the following? A) light and nutrient availability B) predation by primary consumers C) increased pressure with depth D) pollution E) temperature",
        "back": "A"
    },
    {
        "front": "26) Aquatic ecosystems are least likely to be limited by which of the following nutrients? A) nitrogen B) carbon C) phosphorus D) iron E) zinc",
        "back": "B"
    },
    {
        "front": "27) What is the primary limiting factor for aquatic productivity? A) pressure B) lack of nutrients C) light availability D) herbivores E) competition",
        "back": "B"
    },
    {
    ...
    {
        "front": "30) Which of the following lists of organisms is ranked in correct order from lowest to highest percent in production efficiency? A) mammals, fish, insects B) insects, fish, mammals C) fish, insects, mammals D) insects, mammals, fish E) mammals, insects, fish",
        "back": "A"
    },
    {
    ...
    {
        "front": "32) The amount of chemical energy in consumers' food that is converted to their own new biomass during a given time period is known as which of the following? A) biomass B) standing crop C) biomagnification D) primary production E) secondary production",
        "back": "E"
    },
    {
    ...
    {
        "front": "36) Owls eat rats, mice, shrews, and small birds. Assume that, over a period of time, an owl consumes 5,000 J of animal material. The owl loses 2,300 J in feces and owl pellets and uses 2,500 J for cellular respiration. What is the primary efficiency of this owl? A) 0.02% B) 1% C) 4% D) 10% E) 40%",
        "back": "C"
    },
    {
    ...
    {
        "front": "40) Which trophic level is most vulnerable to extinction? A) producer level B) primary consumer level C) secondary consumer level D) tertiary consumer level E) decomposer level",
        "back": "D"
    },
    {
        "front": "41) Secondary consumers that can eat only primary consumers receive what percent of the energy fixed by primary producers in a typical field ecosystem? A) 0.1% B) 1% C) 10% D) 20% E) 80%",
        "back": "B"
    },
    {
    ...
    {
        "front": "43) Consider the food chain grass \u2192 grasshopper \u2192 mouse \u2192 snake \u2192 hawk. How much of the chemical energy fixed by photosynthesis of the grass (100%) is available to the hawk? A) 0.01% B) 0.1% C) 1% D) 10% E) 60%",
        "back": "A"
    },
    {
    ...
    {
        "front": "45) Nitrogen is available to plants only in the form of A) N2 in the atmosphere. B) nitrite ions in the soil. C) uric acid from animal excretions. D) amino acids from decomposing plant and animal proteins. E) nitrate ions in the soil.",
        "back": "E"
    },
    {
        "front": "46) Which of the following locations is the reservoir for nitrogen in the nitrogen cycle? A) atmosphere B) sedimentary bedrock C) fossilized plant and animal remains (coal, oil, and natural gas) D) plant and animal biomass E) soil",
        "back": "A"
    },
    {
        "front": "47) Which of the following locations is the reservoir for carbon for the carbon cycle? A) atmosphere B) sediments and sedimentary rocks C) fossilized plant and animal remains (coal, oil, and natural gas) D) plant and animal biomass E) all of the above",
        "back": "E"
    },
    {
        "front": "48) In the nitrogen cycle, the bacteria that replenish the atmosphere with N2 are A) Rhizobium bacteria. B) nitrifying bacteria. C) denitrifying bacteria. D) methanogenic protozoans. E) nitrogen-fixing bacteria.",
        "back": "C"
    },
    {
        "front": "49) How does phosphorus normally enter ecosystems? A) cellular respiration B) photosynthesis C) rock weathering D) vulcanism E) atmospheric phosphorous gas",
        "back": "C"
    },
    {
    ...
    {
        "front": "52) Which of the following properly links the nutrient to its reservoir? A) nitrogenionic nitrogen in the soil B) wateratmospheric water vapor C) carbondissolved CO\u2082 in aquatic ecosystems D) phosphoroussedimentary rocks E) All of the options are correct.",
        "back": "D"
    },
    {
    ...
    {
        "front": "55) What is the first step in ecosystem restoration? A) to restore the physical structure B) to restore native species that have been extirpated due to disturbance C) to remove competitive invasive species D) to identify the limiting factors of the producers E) to remove toxic pollutants",
        "back": "A"
    },
    {
    ...
    {
        "front": "58) In a typical grassland community, which of the following has the smallest biomass? A) hawk B) snake C) shrew D) grasshopper E) grass",
        "back": "A"
    },
    {
        "front": "59) In a typical grassland community, which of the following is the primary consumer? A) hawk B) snake C) shrew D) grasshopper E) grass",
        "back": "D"
    },
    {
    ...
    {
        "front": "Food web for a particular terrestrial ecosystem (arrows represent energy flow and letters represent species)  61) Examine this food web for a particular terrestrial ecosystem. Which species is autotrophic? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
        "front": "Food web for a particular terrestrial ecosystem (arrows represent energy flow and letters represent species)  62) Examine this food web for a particular terrestrial ecosystem. Which species is most likely a decomposer on this food web? A) A B) B C) C D) D E) E",
        "back": "E"
    },
    {
        "front": "Food web for a particular terrestrial ecosystem (arrows represent energy flow and letters represent species)  63) Examine this food web for a particular terrestrial ecosystem. Species C is toxic to predators. Which species is most likely to benefit from being a mimic of C? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
        "front": "Food web for a particular terrestrial ecosystem (arrows represent energy flow and letters represent species)  64) Examine this food web for a particular terrestrial ecosystem. Which pair of species could be omnivores? A) A and B B) A and D C) B and C D) C and D E) C and E",
        "back": "E"
    },
    {
    ...
    {
        "front": "Diagram of a food web (arrows represent energy flow and letters represent species)  66) If the figure above represents a marine food web, the smallest organism might be A) A. B) F. C) C. D) I. E) E.",
        "back": "A"
    },
    {
        "front": "67) On the diagram of the nitrogen cycle, which number represents nitrite (NO\u2082)? A) 1 B) 2 C) 3 D) 4",
        "back": "C"
    },
    {
        "front": "68) On the diagram of the nitrogen cycle, which number represents ammonia (NH\u2084+)? A) 1 B) 2 C) 3 D) 4",
        "back": "D"
    },
    {
        "front": "69) On the diagram of the nitrogen cycle, which number represents nitrogen-fixing bacteria? A) 5 B) 6 C) 7",
        "back": "A"
    },
    {
        "front": "70) On the diagram of the nitrogen cycle, which number represents nitrifying bacteria? A) 5 B) 6 C) 7",
        "back": "B"
    },
    {
    ...
    {
        "front": "73) A porcupine eats 3,000 J of plant material. Of this, 2,100 J is indigestible and is eliminated as feces, 800 J are used in cellular respiration, and 100 J are used for growth and reproduction. What is the approximate production efficiency of this animal? A) 0.03% B) 3% C) 10% D) 27% E) 33%",
        "back": "B"
    },
    {
        "front": "74) Which of the following organisms is incorrectly paired with its trophic level? A) cyanobacteriumprimary producer B) grasshopperprimary consumer C) zooplanktonprimary producer D) eagletertiary consumer E) fungusdetritivore",
        "back": "C"
    },
    {
        "front": "75) Which of these ecosystems has the lowest net primary production per square meter? A) a salt marsh B) an open ocean C) a coral reef D) a grassland E) a tropical rain forest",
        "back": "B"
    },
    {
        "front": "76) The discipline that applies ecological principles to returning degraded ecosystems to a more natural state is known as A) population viability analysis. B) landscape ecology. C) conservation ecology. D) restoration ecology. E) resource conservation.",
        "back": "D"
    },
    {
    ...
    {
        "front": "Trace elements are those required by an organism in only minute quantities. Which of the following is a trace element that is required by humans and other vertebrates, but not by other organisms such as bacteria or plants? A) nitrogen B) calcium C) iodine D) sodium E) phosphorus",
        "back": "C"
    },
    {
    ...
    {
        "front": "Oxygen has an atomic number of 8 and a mass number of 16. Thus, what is the atomic mass of an oxygen atom? A) exactly 8 grams B) exactly 8 daltons C) approximately 16 grams D) approximately 16 daltons E) 24 amu (atomic mass units)",
        "back": "D"
    },
    {
    ...
    {
        "front": "Which of the following best describes the relationship between the atoms described below? [SEE IMAGE] A) They are isomers. B) They are polymers. C) They are isotopes. D) They contain 1 and 3 protons, respectively. E) They each contain 1 neutron.",
        "back": "C"
    },
    {
    ...
    {
        "front": "One difference between carbon-12 (12/6 C) is that carbon-14 (14/6 C) has A) two more protons than carbon-12. B) two more electrons than carbon-12. C) two more neutrons than carbon-12. D) two more protons and two more neutrons than carbon-12. E) two more electrons and two more neutrons than carbon-12.",
        "back": "C"
    },
    {
        "front": "An atom has 6 electrons in its outer shell. How many unpaired electrons does it have? A) 0 B) 2 C) 4 D) 6 E) 2 or 4",
        "back": "B"
    },
    {
        "front": "The atomic number of nitrogen is 7. Nitrogen-15 is heavier than nitrogen-14 because the atomic nucleus of nitrogen-15 contains how many neutrons? A) 6 B) 7 C) 8 D) 12 E) 14",
        "back": "C"
    },
    {
    ...
    {
        "front": "From its atomic number of 15, it is possible to predict that the phosphorus atom has A) 15 neutrons. B) 15 protons. C) 15 electrons. D) 8 electrons in its outermost electron shell. E) 15 protons and 15 electrons.",
        "back": "E"
    },
    {
        "front": "Atoms whose outer electron shells contain 8 electrons tend to A) form ions in aqueous solutions. B) form hydrogen bonds in aqueous solutions. C) be stable and chemically nonreactive, or inert. D) be gaseous at room temperature. E) be both chemically inert and gaseous at room temperature.",
        "back": "E"
    },
    {
        "front": "The atomic number of each atom is given to the left of each of the elements below. Which of the atoms has the same valence as carbon (12/6 C)? A) \u2087N nitrogen B) \u2089F flourine C) \u2081\u2080Ne neon D) \u2081\u2082Mg magnesium E) \u2081\u2084Si silicon",
        "back": "E"
    },
    {
    ...
    {
        "front": "Fluorine has an atomic number of 9 and a mass number of 19. How many electrons are needed to complete the valence shell of a fluorine atom? A) 1 B) 3 C) 0 D) 7 E) 9",
        "back": "A"
    },
    {
        "front": "24) What is the maximum number of electrons in a single 2 p orbital of an atom? A) 1 B) 2 C) 3 D) 4 E) 5",
        "back": "B"
    },
    {
    ...
    {
        "front": "If an atom of sulfur (atomic number 16) were allowed to react with atoms of hydrogen (atomic number 1), which of the molecules below would be formed?  [SEE IMAGE FOR CHOICES]",
        "back": "B"
    },
    {
        "front": "What is the maximum number of covalent bonds an element with atomic number 8 can make with hydrogen? A) 1 B) 2 C) 3 D) 4 E) 6",
        "back": "B"
    },
    {
    ...
    {
        "front": "When two atoms are equally electronegative, they will interact to form A) hydrogen bonds. B) van der Waals interactions. C) polar covalent bonds. D) nonpolar covalent bonds. E) ionic bonds.",
        "back": "D"
    },
    {
        "front": "What results from an unequal sharing of electrons between atoms? A) a nonpolar covalent bond B) a polar covalent bond C) an ionic bond D) a hydrogen bond E) a hydrophobic interaction",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of the following molecules contains the most polar covalent bond? A) H\u2082 B) O\u2082 C) CO\u2082 D) H\u2082O E) CH\u2084",
        "back": "D"
    },
    {
    ...
    {
        "front": "In ammonium chloride salt (NH\u2084Cl) the anion is a single chloride ion, Cl. What is the cation of NH\u2084Cl? A) N, with a charge of +1 B) NH, with a charge of +1 C) H\u2083, with a charge of +1 D) NH\u2084, with a charge of +1 E) NH\u2084, with a charge of +4",
        "back": "D"
    },
    {
        "front": "The atomic number of chlorine is 17. The atomic number of magnesium is 12. What is the formula for magnesium chloride? A) MgCl B) MgCl\u2082 C) Mg\u2082Cl D) Mg\u2082Cl\u2082 E) MgCl\u2083",
        "back": "B"
    },
    {
        "front": "How many electron pairs are shared between carbon atoms in a molecule that has the formula C\u2082H\u2084? A) 0 B) 1 C) 2 D) 3 E) 4",
        "back": "C"
    },
    {
        "front": "Which bond or interaction would be difficult to disrupt when compounds are put into water? A) covalent bond B) hydrogen bond C) van der Waals interaction D) ionic bond E) either covalent bonds or ionic bonds",
        "back": "A"
    },
    {
        "front": "Which of the following explains most specifically the attraction of water molecules to one another? A) nonpolar covalent bond B) polar covalent bond C) ionic bond D) hydrogen bond E) hydrophobic interaction",
        "back": "D"
    },
    {
        "front": "Van der Waals interactions result when A) hybrid orbitals overlap. B) electrons are not symmetrically distributed in a molecule. C) molecules held by ionic bonds react with water. D) two polar covalent bonds react. E) a hydrogen atom loses an electron.",
        "back": "B"
    },
    {
        "front": "What bonding or interaction is most likely to occur among a broad array of molecules of various types (polar, nonpolar, hydrophilic, hydrophobic)? A) covalent bonding B) polar covalent bonding C) ionic bonding D) hydrogen bonding E) van der Waals interactions",
        "back": "E"
    },
    {
        "front": "Which of the following is not considered to be a weak molecular interaction? A) a covalent bond B) a van der Waals interaction C) an ionic bond in the presence of water D) a hydrogen bond E) both a hydrogen bond and a covalent bond",
        "back": "A"
    },
    {
        "front": "Which of the following would be regarded as compounds? A) H\u2082O, O\u2082, and CH\u2084 B) H\u2082O and O\u2082 C) O\u2082 and CH\u2084 D) CH\u2084 and O\u2082, but not H\u2082O E) H\u2082O and CH\u2084, but not O\u2082",
        "back": "E"
    },
    {
        "front": "What is the maximum number of hydrogen atoms that can be covalently bonded in a molecule containing two carbon atoms? A) 2 B) 3 C) 4 D) 6 E) 8",
        "back": "D"
    },
    {
    ...
    {
        "front": "Refer to the figure above (first three rows of the periodic table). If life arose on a planet where carbon is absent, which element might fill the role of carbon? A) boron B) silicon C) nitrogen D) aluminum E) phosphorus",
        "back": "B"
    },
    {
        "front": "Which drawing in the figure above depicts the electron configuration of an element with chemical properties most similar to Helium (\u2082He)? A) A B) B C) C D) D E) E",
        "back": "E"
    },
    {
        "front": "Which drawing in the figure above depicts the electron configuration of an atom that can form covalent bonds with two hydrogen atoms? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "Which drawing in the figure above depicts the electron configuration of an atom capable of forming three covalent bonds with other atoms? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
        "front": "Which drawing in the figure above is of the electron configuration of a sodium \u2081\u2081Na\u207a ion? A) A B) B C) C D) D E) E",
        "back": "E"
    },
    {
        "front": "Which drawing in the figure above depicts the most electronegative atom? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
        "front": "Which drawing in the figure above depicts an atom with a valence of 3? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
        "front": "Which drawing in the figure above depicts an atom with a valence of 2? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "In the figure above, how many electrons does nitrogen have in its valence shell? A) 2 B) 5 C) 7 D) 8 E) 14",
        "back": "B"
    },
    {
        "front": "In the figure above, how many unpaired electrons does phosphorus have in its valence shell? A) 15 B) 2 C) 3 D) 7 E) 5",
        "back": "C"
    },
    {
        "front": "How many neutrons are present in the nucleus of a phosphorus-32 (\u00b3\u00b2P) atom (see the figure above)? A) 5 B) 15 C) 16 D) 17 E) 32",
        "back": "D"
    },
    {
        "front": "How many electrons does an atom of sulfur have in its valence shell (see the figure above)? A) 4 B) 6 C) 8 D) 16 E) 32",
        "back": "B"
    },
    {
        "front": "Based on electron configuration, which of these elements in the figure above would exhibit a chemical behavior most like that of oxygen? A) carbon B) hydrogen C) nitrogen D) sulfur E) phosphorus",
        "back": "D"
    },
    {
    ...
    {
        "front": "What results from the chemical reaction illustrated above? A) a cation with a net charge of +1 B) a cation with a net charge of -1 C) an anion with a net charge of +1 D) an anion with a net charge of -1 E) a cation with a net charge of +1 and an anion with a net charge of -1",
        "back": "E"
    },
    {
        "front": "What is the atomic number of the cation formed in the reaction illustrated above? A) 1 B) 8 C) 10 D) 11 E) 16",
        "back": "D"
    },
    {
    ...
    {
        "front": "Which one of the atoms shown would be most likely to form a cation with a charge of +1?  [SEE IMAGE FOR CHOICES]",
        "back": "A"
    },
    {
        "front": "Which one of the atoms shown would be most likely to form an anion with a charge of -1?  [SEE IMAGE FOR CHOICES]",
        "back": "D"
    },
    {
        "front": "Which of the following pairs of atoms would be most likely to form a polar covalent bond?  [SEE IMAGE FOR CHOICES]",
        "back": "A"
    },
    {
        "front": "Which of the following pairs of atoms would be most likely to form an ionic bond?  [SEE IMAGE FOR CHOICES]",
        "back": "B"
    },
    {
    ...
    {
        "front": "Compared with \u00b3\u00b9P, the radioactive isotope \u00b3\u00b2P has A) a different atomic number. B) a different charge. C) one more proton. D) one more electron. E) one more neutron.",
        "back": "E"
    },
    {
    ...
    {
        "front": "Which statement is true of all atoms that are anions? A) The atom has more electrons than protons. B) The atom has more protons than electrons. C) The atom has fewer protons than does a neutral atom of the same element. D) The atom has more neutrons than protons. E) The net charge is 1-.",
        "back": "A"
    },
    {
    ...
    {
        "front": "We can represent atoms by listing the number of protons, neutrons, and electrons: for example, 2p\u207a; 2n\u2070; 2e\u207b for helium. Which of the following represents the 18O isotope of oxygen? A) 6p\u207a, 8n\u2070, 6e\u207b B) 8p\u207a, 10n\u2070, 8e\u207b C) 9p\u207a, 9n\u2070, 9e\u207b D) 7p\u207a, 2n\u2070, 9e\u207b E) 10p\u207a, 8n\u2070, 9e\u207b",
        "back": "B"
    },
    {
        "front": "The atomic number of sulfur is 16. Sulfur combines with hydrogen by covalent bonding to form a compound, hydrogen sulfide. Based on the number of valence electrons in a sulfur atom, predict the molecular formula of the compound: A) HS B) HS\u2082 C) H\u2082S D) H\u2083S\u2082 E) H\u2084S",
        "back": "C"
    },
    {
        "front": "What coefficients must be placed in the following blanks so that all atoms are accounted for in the products? C\u2086H\u2081\u2082O\u2086 \u2192 ____ C\u2082H\u2086O + ____ CO\u2082 A) 1; 2 B) 3; 1 C) 1; 3 D) 1; 1 E) 2; 2",
        "back": "E"
    },
    {
        "front": "In a single molecule of water, two hydrogen atoms are bonded to a single oxygen atom by A) hydrogen bonds. B) nonpolar covalent bonds. C) polar covalent bonds. D) ionic bonds. E) van der Waals interactions.",
        "back": "C"
    },
    {
        "front": "The slight negative charge at one end of one water molecule is attracted to the slight positive charge of another water molecule. What is this attraction called? A) a covalent bond B) a hydrogen bond C) an ionic bond D) a hydrophilic bond E) a van der Waals interaction",
        "back": "B"
    },
    {
    ...
    {
        "front": "Water molecules are able to form hydrogen bonds with A) compounds that have polar covalent bonds. B) oils. C) oxygen gas (O\u2082) molecules. D) chloride ions. E) any compound that is not soluble in water.",
        "back": "A"
    },
    {
    ...
    {
        "front": "Which type of bond must be broken for water to vaporize? A) ionic bonds B) both hydrogen bonds and ionic bonds C) polar covalent bonds D) hydrogen bonds E) both polar covalent bonds and hydrogen bonds",
        "back": "D"
    },
    {
    ...
    {
        "front": "One mole (mol) of glucose (molecular mass = 180 daltons) is A) 180 \u00d7 10\u00b2\u00b3 molecules of glucose. B) 1 kg of glucose dissolved in 1 L of solution. C) the largest amount of glucose that can be dissolved in 1 L of solution. D) 180 kilograms of glucose. E) both 180 grams of glucose and 6.02 \u00d7 10\u00b2\u00b3 molecules of glucose.",
        "back": "E"
    },
    {
        "front": "How many molecules of glucose (C\u2086H\u2081\u2082O\u2086 molecular mass = 180 daltons) would be present in 90 grams of glucose? A) 90 \u00d7 10\u00b2\u00b3 B) (6.02/180) \u00d7 10\u00b2\u00b3 C) (6.02/90) \u00d7 10\u00b2\u00b3 D) (90 x 6.02) \u00d7 10\u00b2\u00b3 E) (90/180) \u00d7 6.02 \u00d7 10\u00b2\u00b3",
        "back": "E"
    },
    {
        "front": "How many molecules of glycerol (C\u2083H\u2088O\u2083; molecular mass = 92) would be present in 1 L of a 1 M glycerol solution? A) 1 \u00d7 10\u2076 B) 14 \u00d7 6.02 \u00d7 10\u00b2\u00b3 C) 92 \u00d7 6.02 \u00d7 10\u00b2\u00b3 D) 6.02 \u00d7 10\u00b2\u2076 E) 6.02 \u00d7 10\u00b2\u00b3",
        "back": "E"
    },
    {
    ...
    {
        "front": "You have a freshly prepared 0.1 M solution of glucose in water. Each liter of this solution contains how many glucose molecules? A) 6.02 \u00d7 10\u00b2\u00b3 B) 3.01 \u00d7 10\u00b2\u00b3 C) 6.02 \u00d7 10\u00b2\u2074 D) 12.04 \u00d7 10\u00b2\u00b3 E) 6.02 \u00d7 10\u00b2\u00b2",
        "back": "E"
    },
    {
        "front": "The molecular weight of water is 18 daltons. What is the molarity of 1 liter of pure water? (Hint: What is the mass of 1 liter of pure water?) A) 55.6 M B) 18 M C) 37 M D) 0.66 M E) 1.0 M",
        "back": "A"
    },
    {
        "front": "You have a freshly prepared 1 M solution of glucose in water. You carefully pour out a 100 mL sample of that solution. How many glucose molecules are included in that 100 mL sample? A) 6.02 \u00d7 10\u00b2\u00b3 B) 3.01 \u00d7 10\u00b2\u00b3 C) 6.02 \u00d7 10\u00b2\u2074 D) 12.04 \u00d7 10\u00b2\u00b3 E) 6.02 \u00d7 10\u00b2\u00b2",
        "back": "E"
    },
    {
        "front": "A strong acid like HCl A) ionizes completely in an aqueous solution. B) increases the pH when added to an aqueous solution. C) reacts with strong bases to create a buffered solution. D) is a strong buffer at low pH. E) both ionizes completely in aqueous solutions and is a strong buffer at low pH.",
        "back": "A"
    },
    {
        "front": "Which of the following ionizes completely in solution and is considered to be a strong base (alkali)? A) NaCl B) HCl C) NH\u2083 D) H\u2082CO\u2083 E) NaOH",
        "back": "E"
    },
    {
        "front": "A 0.01 M solution of a substance has a pH of 2. What can you conclude about this substance? A) It is a strong acid that ionizes completely in water. B) It is a strong base that ionizes completely in water. C) It is a weak acid. D) It is a weak base. E) It is neither an acid nor a base.",
        "back": "A"
    },
    {
    ...
    {
        "front": "A solution contains 0.0000001(10\u207b\u2077) moles of hydroxyl ions [OH\u207b] per liter. Which of the following best describes this solution? A) acidic: H\u207a acceptor B) basic: H\u207a acceptor C) acidic: H\u207a donor D) basic: H\u207a donor E) neutral",
        "back": "E"
    },
    {
        "front": "What is the pH of a solution with a hydroxyl ion [OH\u207b] concentration of 10\u207b\u00b9\u00b2 M? A) pH 2 B) pH 4 C) pH 10 D) pH 12 E) pH 14",
        "back": "A"
    },
    {
        "front": "What is the pH of a 1 millimolar NaOH solution? A) pH 3 B) pH 8 C) pH 9 D) pH 10 E) pH 11",
        "back": "E"
    },
    {
        "front": "Which of the following solutions would require the greatest amount of base to be added to bring the solution to neutral pH? A) gastric juice at pH 2 B) vinegar at pH 3 C) tomato juice at pH 4 D) black coffee at pH 5 E) household bleach at pH 12",
        "back": "A"
    },
    {
        "front": "What is the hydrogen ion [H\u207a] concentration of a solution of pH 8? A) 8 M B) 8 x 10\u207b\u2076 M C) 0.01 M D) 10\u207b\u2078 M E) 10\u207b\u2076 M",
        "back": "D"
    },
    {
    ...
    {
        "front": "One liter of a solution of pH 2 has how many more hydrogen ions (H\u207a) than 1 L of a solution of pH 6? A) 4 times more B) 16 times more C) 40,000 times more D) 10,000 times more E) 100,000 times more",
        "back": "D"
    },
    {
        "front": "One liter of a solution of pH 9 has how many more hydroxyl ions (OH\u207b) than 1 L of a solution of pH 4? A) 5 times more B) 32 times more C) 50,000 times more D) 10,000 times more E) 100,000 times more",
        "back": "E"
    },
    {
    ...
    {
        "front": "Based on your knowledge of the polarity of water molecules, the solute molecule depicted here is most likely A) positively charged. B) negatively charged. C) without charge. D) hydrophobic. E) nonpolar.",
        "back": "A"
    },
    {
        "front": "How many grams would be equal to 1 mol of the compound shown in the figure above? (carbon = 12, oxygen = 16, hydrogen = 1) A) 29 B) 30 C) 60 D) 150 E) 342",
        "back": "C"
    },
    {
        "front": "How many grams of the compound in the figure above would be required to make 1 L of a 0.5 M solution? (carbon = 12, oxygen = 16, hydrogen = 1) A) 29 B) 30 C) 60 D) 150 E) 342",
        "back": "B"
    },
    {
        "front": "How many grams of the compound in the figure above would be required to make 2.5 L of a 1 M solution? (carbon = 12, oxygen = 16, hydrogen = 1) A) 29 B) 30 C) 60 D) 150 E) 342",
        "back": "D"
    },
    {
    ...
    {
        "front": "Carbon dioxide (CO\u2082) is readily soluble in water, according to the equation CO\u2082 + H\u2082O \u2194 H\u2082CO\u2083. Carbonic acid (H\u2082CO\u2083) is a weak acid. If CO\u2082 is bubbled into a beaker containing pure, freshly distilled water, which of the following graphs correctly describes the results?",
        "back": "B"
    },
    {
    ...
    {
        "front": "You have two beakers. One contains a solution of HCl at pH = 1.0. The other contains a solution of NaOH at pH = 13. Into a third beaker, you slowly and cautiously pour 20 mL of the HCl and 20 mL of the NaOH. After complete stirring, the pH of the mixture will be A) 2.0. B) 12.0. C) 7.0. D) 5.0. E) 9.0.",
        "back": "C"
    },
    {
    ...
    {
        "front": "The bonds that are broken when water vaporizes are A) ionic bonds. B) hydrogen bonds between water molecules. C) covalent bonds between atoms within water molecules. D) polar covalent bonds. E) nonpolar covalent bonds.",
        "back": "B"
    },
    {
        "front": "Which of the following is a hydrophobic material? A) paper B) table salt C) wax D) sugar E) pasta",
        "back": "C"
    },
    {
        "front": "We can be sure that a mole of table sugar and a mole of vitamin C are equal in their A) mass in daltons. B) mass in grams. C) volume. D) number of atoms. E) number of molecules.",
        "back": "E"
    },
    {
        "front": "Measurements show that the pH of a particular lake is 4.0. What is the hydrogen ion concentration of the lake? A) 4.0 M B) 10\u207b\u00b9\u2070 M C) 10\u207b\u2074 M D) 10\u2074 M E) 4%",
        "back": "C"
    },
    {
        "front": "Measurements show that the pH of a particular lake is 4.0. What is the hydroxide ion concentration of the lake? A) 10\u207b\u00b9\u2070 M B) 10\u207b\u2074 M C) 10\u207b\u2077 M D) 10\u207b\u00b9\u2074 M E) 10 M",
        "back": "A"
    },
    {
        "front": "A slice of pizza has 500 kcal. If we could burn the pizza and use all the heat to warm a 50-L container of cold water, what would be the approximate increase in the temperature of the water? (Note: A liter of cold water weighs about 1 kg.) A) 50\u00b0C B) 5\u00b0C C) 1\u00b0C D) 100\u00b0C E) 10\u00b0C",
        "back": "E"
    },
    {
        "front": "How many grams of acetic acid (C\u2082H\u2084O\u2082) would you use to make 10 L of a 0.1 M aqueous solution of acetic acid? (Note: The atomic masses, in daltons, are approximately 12 for carbon, 1 for hydrogen, and 16 for oxygen.) A) 10 g B) 0.1 g C) 6.0 g D) 60 g E) 0.6 g",
        "back": "D"
    },
    {
        "front": "The element present in all organic molecules is A) hydrogen. B) oxygen. C) carbon. D) nitrogen. E) phosphorus.",
        "back": "C"
    },
    {
        "front": "The complexity and variety of organic molecules is due to A) the chemical versatility of carbon atoms. B) the variety of rare elements in organic molecules. C) the fact that they can be synthesized only in living organisms. D) their interaction with water. E) their tremendously large sizes.",
        "back": "A"
    },
    {
    ...
    {
        "front": "Which of the following people was the first to synthesize an organic compound, urea, from inorganic starting materials? A) Stanley Miller B) Jakob Berzelius C) Friedrich Wohler D) Hermann Kolbe E) August Kekul\u00e9",
        "back": "C"
    },
    {
    ...
    {
        "front": "How many electron pairs does carbon share in order to complete its valence shell? A) 1 B) 2 C) 3 D) 4 E) 8",
        "back": "D"
    },
    {
        "front": "A carbon atom is most likely to form what kind of bond(s) with other atoms? A) ionic B) hydrogen C) covalent D) covalent bonds and hydrogen bonds E) ionic bonds, covalent bonds, and hydrogen bonds",
        "back": "C"
    },
    {
    ...
    {
        "front": "How many structural isomers are possible for a substance having the molecular formula C\u2084H\u2081\u2080? A) 1 B) 2 C) 4 D) 3 E) 11",
        "back": "B"
    },
    {
    ...
    {
        "front": "Compared to a hydrocarbon chain where all the carbon atoms are linked by single bonds, a hydrocarbon chain with the same number of carbon atoms, but with one or more double bonds, will A) be more flexible in structure. B) be more constrained in structure. C) be more polar. D) have more hydrogen atoms. E) have fewer structurally distinct isomers.",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of the following is a false statement concerning amino groups? A) They are basic in pH. B) They are found in amino acids. C) They contain nitrogen. D) They are nonpolar. E) They are components of urea.",
        "back": "D"
    },
    {
        "front": "Which two functional groups are always found in amino acids? A) ketone and methyl B) carbonyl and amino C) carboxyl and amino D) amino and sulfhydryl E) hydroxyl and carboxyl",
        "back": "C"
    },
    {
        "front": "Amino acids are acids because they always possess which functional group? A) amino B) carbonyl C) carboxyl D) phosphate E) hydroxyl",
        "back": "C"
    },
    {
    ...
    {
        "front": "Which functional groups can act as acids? A) amino and sulfhydryl B) carbonyl and carboxyl C) carboxyl and phosphate D) hydroxyl and aldehyde E) ketone and amino",
        "back": "C"
    },
    {
        "front": "Testosterone and estradiol are A) soluble in water. B) structural isomers of each other. C) proteins. D) lipids. E) enantiomers of each other.",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of the following people used this apparatus to study the formation of organic compounds? A) Stanley Miller B) Jakob Berzelius C) Friedrich Wohler D) Hermann Kolbe E) August Kekul\u00e9",
        "back": "A"
    },
    {
        "front": "The two molecules shown in the figure above are best described as A) optical isomers. B) enantiomers. C) structural isomers. D) cis-trans isomers. E) chain length isomers.",
        "back": "C"
    },
    {
    ...
    {
        "front": "The figure above shows the structures of glucose and fructose. These two molecules are A) geometric isotopes. B) enantiomers. C) cis-trans isomers. D) structural isomers. E) nonisotopic isomers.",
        "back": "D"
    },
    {
        "front": "The two molecules shown in the figure above are best described as A) enantiomers. B) radioactive isotopes. C) structural isomers. D) nonisotopic isomers. E) cis-trans isomers.",
        "back": "E"
    },
    {
    ...
    {
        "front": "Which of the pairs of molecular structures shown below depict enantiomers (enantiomeric forms) of the same molecule?  [SEE IMAGE FOR CHOICES]",
        "back": "D"
    },
    {
        "front": "Which of the pairs of molecular structures shown below do NOT depict enantiomers (enantiomeric forms) of the same molecule?  [SEE IMAGE FOR CHOICES]",
        "back": "C"
    },
    {
        "front": "Which pair of molecules shown below are not enantiomers of a single molecule?  [SEE IMAGE FOR CHOICES]",
        "back": "B"
    },
    {
    ...
    {
        "front": "What is the name of the functional group shown in the figure above? A) carbonyl B) ketone C) aldehyde D) carboxyl E) hydroxyl",
        "back": "D"
    },
    {
        "front": "Which of the structures illustrated above is an impossible covalently bonded molecule? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "Which of the structures illustrated above contain(s) a carbonyl functional group? A) A B) C and D C) C D) D E) C and E",
        "back": "D"
    },
    {
        "front": "In which of the structures illustrated above are the atoms bonded by ionic bonds? A) A B) B C) C D) C, D, and E only E) none of the structures",
        "back": "E"
    },
    {
        "front": "Which of the structures illustrated above cannot form hydrogen bonds with water molecules? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
        "front": "Which functional group shown above is characteristic of alcohols? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
        "front": "Which functional group(s) shown above is (are) present in all amino acids? A) A and B B) B and D C) C only D) D only E) C and D",
        "back": "E"
    },
    {
        "front": "Which of the groups shown above is a carbonyl functional group? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
        "front": "Which of the groups shown above is a functional group that helps stabilize proteins by forming covalent cross-links within or between protein molecules? A) A B) B C) C D) D E) E",
        "back": "E"
    },
    {
        "front": "Which of the groups above is a carboxyl functional group? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "Which of the groups above is an acidic functional group that can dissociate and release H\u207a into a solution? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "Which of the groups above is a basic functional group that can accept H\u207a and become positively charged? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
        "front": "Which molecule shown above would have a positive charge in aqueous solution at pH 7? A) A B) B C) C D) D E) E",
        "back": "E"
    },
    {
        "front": "Which molecule(s) shown above is (are) ionized in aqueous solution at pH 7? A) A B) B and D C) D and E D) D E) E",
        "back": "A"
    },
    {
        "front": "Which molecules shown above contain a carbonyl group? A) A and B B) B and C C) B, C, and D D) D and E E) E and A",
        "back": "B"
    },
    {
        "front": "Which molecule shown above has a carbonyl functional group in the form of a ketone? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "Which molecule shown above has a carbonyl functional group in the form of an aldehyde? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
        "front": "Which molecule shown above contains a carboxyl group? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
        "front": "Which molecule shown above can increase the concentration of hydrogen ions in a solution and is therefore an organic acid? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
        "front": "Which molecule shown above can form a dimer linked by a covalent bond? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which molecule shown above contains an amino functional group, but is not an amino acid? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
    ...
    {
        "front": "Which molecule shown above contains a functional group that cells use to transfer energy between organic molecules? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
        "front": "Which molecule shown above can function as a base? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
        "front": "A chemist wishes to make an organic molecule less acidic. Which of the following functional groups should be added to the molecule in order to do so? A) carboxyl B) sulfhydryl C) hydroxyl D) amino E) phosphate",
        "back": "D"
    },
    {
        "front": "Organic chemistry is currently defined as A) the study of compounds made only by living cells. B) the study of carbon compounds. C) the study of vital forces. D) the study of natural (as opposed to synthetic) compounds. E) the study of hydrocarbons.",
        "back": "B"
    },
    {
        "front": "Which functional group is not present in this molecule? A) carboxyl B) sulfhydryl C) hydroxyl D) amino",
        "back": "B"
    },
    {
        "front": "Which chemical group is most likely to be responsible for an organic molecule behaving as a base? A) hydroxyl B) carbonyl C) carboxyl D) amino E) phosphate",
        "back": "D"
    },
    {
        "front": "Which of the following hydrocarbons has a double bond in its carbon skeleton? A) C\u2083H\u2088 B) C\u2082H\u2086 C) CH\u2084 D) C\u2082H\u2084 E) C\u2082H\u2082",
        "back": "D"
    },
    {
        "front": "Choose the term that correctly describes the relationship between these two sugar molecules: A) structural isomers B) cis-trans isomers C) enantiomers D) isotopes",
        "back": "A"
    },
    {
        "front": "Identify the asymmetric carbon in this molecule. A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
        "front": "Which action could produce a carbonyl group? A) the replacement of the OH of a carboxyl group with hydrogen B) the addition of a thiol to a hydroxyl C) the addition of a hydroxyl to a phosphate D) the replacement of the nitrogen of an amine with oxygen E) the addition of a sulfhydryl to a carboxyl",
        "back": "A"
    },
    {
    ...
    {
        "front": "Molecules with which functional groups may form polymers via dehydration reactions? A) hydroxyl groups B) carbonyl groups C) carboxyl groups D) either carbonyl or carboxyl groups E) either hydroxyl or carboxyl groups",
        "back": "E"
    },
    {
        "front": "Which of these molecules is not formed by dehydration reactions? A) fatty acids B) disaccharides C) DNA D) protein E) amylose",
        "back": "A"
    },
    {
    ...
    {
        "front": "Which of these classes of biological molecules consist of both small molecules and macromolecular polymers? A) lipids B) carbohydrates C) proteins D) nucleic acids E) lipids, carbohydrates, proteins, and nucleic acids all consist of only macromolecular polymers",
        "back": "B"
    },
    {
        "front": "Which of the following is not a polymer? A) glucose B) starch C) cellulose D) chitin E) DNA",
        "back": "A"
    },
    {
        "front": "What is the chemical reaction mechanism by which cells make polymers from monomers? A) phosphodiester linkages B) hydrolysis C) dehydration reactions D) ionic bonding of monomers E) the formation of disulfide bridges between monomers",
        "back": "C"
    },
    {
        "front": "How many molecules of water are needed to completely hydrolyze a polymer that is 11 monomers long? A) 12 B) 11 C) 10 D) 9 E) 8",
        "back": "C"
    },
    {
    ...
    {
        "front": "Which of the following polymers contain nitrogen? A) starch B) glycogen C) cellulose D) chitin E) amylopectin",
        "back": "D"
    },
    {
        "front": "The molecular formula for glucose is C\u2086H\u20812O\u2086. What would be the molecular formula for a molecule made by linking three glucose molecules together by dehydration reactions? A) C\u2081\u2088H\u2083\u2086O\u2081\u2088 B) C\u2081\u2088H\u2083\u2082O\u2081\u2086 C) C\u2086H\u2081\u2080O\u2085 D) C1\u2088H\u2081\u2080O\u2081\u2085 E) C\u2083H\u2086O\u2083",
        "back": "B"
    },
    {
        "front": "The enzyme amylase can break glycosidic linkages between glucose monomers only if the monomers are the \u03b1 form. Which of the following could amylase break down? A) glycogen B) cellulose C) chitin D) glycogen and chitin only E) glycogen, cellulose, and chitin",
        "back": "A"
    },
    {
        "front": "On food packages, to what does the term insoluble fiber refer? A) cellulose B) polypeptides C) starch D) amylopectin E) chitin",
        "back": "A"
    },
    {
        "front": "A molecule with the chemical formula C\u2086H\u2081\u2082O\u2086 is probably a A) carbohydrate. B) lipid. C) monosaccharide D) carbohydrate and lipid only. E) carbohydrate and monosaccharide only.",
        "back": "E"
    },
    {
        "front": "Lactose, a sugar in milk, is composed of one glucose molecule joined by a glycosidic linkage to one galactose molecule. How is lactose classified? A) as a pentose B) as a hexose C) as a monosaccharide D) as a disaccharide E) as a polysaccharide",
        "back": "D"
    },
    {
        "front": "All of the following are polysaccharides except A) lactose. B) glycogen. C) chitin. D) cellulose. E) amylopectin.",
        "back": "A"
    },
    {
        "front": "Which of the following is true of both starch and cellulose? A) They are both polymers of glucose. B) They are cis-trans isomers of each other. C) They can both be digested by humans. D) They are both used for energy storage in plants. E) They are both structural components of the plant cell wall.",
        "back": "A"
    },
    {
    ...
    {
        "front": "A molecule with the formula C\u2081\u2088H3\u2086O\u2082 is probably a A) carbohydrate. B) fatty acid. C) protein. D) nucleic acid. E) hydrocarbon.",
        "back": "B"
    },
    {
    ...
    {
        "front": "Large organic molecules are usually assembled by polymerization of a few kinds of simple subunits. Which of the following is an exception to this statement? A) a steroid B) cellulose C) DNA D) an enzyme E) a contractile protein",
        "back": "A"
    },
    {
    ...
    {
        "front": "Why are human sex hormones considered to be lipids? A) They are essential components of cell membranes. B) They are not soluble in water. C) They are made of fatty acids. D) They are hydrophilic compounds. E) They contribute to atherosclerosis.",
        "back": "B"
    },
    {
        "front": "All of the following contain amino acids except A) hemoglobin. B) cholesterol. C) antibodies. D) enzymes. E) insulin.",
        "back": "B"
    },
    {
        "front": "The bonding of two amino acid molecules to form a larger molecule requires A) the release of a water molecule. B) the release of a carbon dioxide molecule. C) the addition of a nitrogen atom. D) the addition of a water molecule. E) the release of a nitrous oxide molecule.",
        "back": "A"
    },
    {
    ...
    {
        "front": "The bonding of two amino acid molecules to form a larger molecule requires which of the following? A) removal of a water molecule B) addition of a water molecule C) formation of a glycosidic bond D) formation of a hydrogen bond E) both removal of a water molecule and formation of a hydrogen bond",
        "back": "A"
    },
    {
    ...
    {
        "front": "Dehydration reactions are used in forming which of the following compounds? A) triacylglycerides B) polysaccharides C) proteins D) triacylglycerides and proteins only E) triacylglycerides, polysaccharides, and proteins",
        "back": "E"
    },
    {
        "front": "Upon chemical analysis, a particular polypeptide was found to contain 100 amino acids. How many peptide bonds are present in this protein? A) 101 B) 100 C) 99 D) 98 E) 97",
        "back": "C"
    },
    {
        "front": "What aspects of protein structure are stabilized or assisted by hydrogen bonds? A) primary structure B) secondary structure C) tertiary structure D) quaternary structure E) secondary, tertiary, and quaternary structures, but not primary structure",
        "back": "E"
    },
    {
        "front": "How many different kinds of polypeptides, each composed of 12 amino acids, could be synthesized using the 20 common amino acids? A) 4\u00b9\u00b2 B) 12\u00b2\u2070 C) 240 D) 20 E) 20\u00b9\u00b2",
        "back": "E"
    },
    {
        "front": "Which bonds are created during the formation of the primary structure of a protein? A) peptide bonds B) hydrogen bonds C) disulfide bonds D) phosphodiester bonds E) peptide bonds, hydrogen bonds, and disulfide bonds",
        "back": "A"
    },
    {
        "front": "What maintains the secondary structure of a protein? A) peptide bonds B) hydrogen bonds between the amino group of one peptide bond and the carboxyl group of another peptide bond C) disulfide bonds D) hydrophobic interactions E) hydrogen bonds between the R groups",
        "back": "B"
    },
    {
        "front": "Which type of interaction stabilizes the \u03b1 helix and the \u03b2 pleated sheet structures of proteins? A) hydrophobic interactions B) disulfide bonds C) ionic bonds D) hydrogen bonds E) peptide bonds",
        "back": "D"
    },
    {
        "front": "Which level of protein structure do the \u03b1 helix and the \u03b2 pleated sheet represent? A) primary B) secondary C) tertiary D) quaternary E) primary, secondary, tertiary, and quaternary",
        "back": "B"
    },
    {
        "front": "The amino acids of the protein keratin are arranged predominantly in an \u03b1 helix. This secondary structure is stabilized by A) covalent bonds. B) peptide bonds. C) ionic bonds. D) polar bonds. E) hydrogen bonds.",
        "back": "E"
    },
    {
    ...
    {
        "front": "What type of covalent bond between amino acid side chains (R groups) functions in maintaining a polypeptide's specific three-dimensional shape? A) ionic bond B) hydrophobic interaction C) van der Waals interaction D) disulfide bond E) hydrogen bond",
        "back": "D"
    },
    {
        "front": "At which level of protein structure are interactions between the side chains (R groups) most important? A) primary B) secondary C) tertiary D) quaternary E) all of the above",
        "back": "C"
    },
    {
    ...
    {
        "front": "What methods may be used to elucidate the structures of purified proteins? A) X-ray crystallography B) bioinformatics C) analysis of amino acid sequence of small fragments D) NMR spectroscopy E) both X-ray crystallography and NMR spectroscopy",
        "back": "E"
    },
    {
    ...
    {
        "front": "Which of the following techniques uses the amino acid sequences of polypeptides to predict a protein's three-dimensional structure? A) X-ray crystallography B) bioinformatics C) analysis of amino acid sequence of small fragments D) NMR spectroscopy E) high-speed centrifugation",
        "back": "B"
    },
    {
        "front": "If cells are grown in a medium containing radioactive \u00b3\u2075S, which of these molecules will be labeled? A) phospholipids B) nucleic acids C) proteins D) amylose E) both proteins and nucleic acids",
        "back": "C"
    },
    {
        "front": "What is the term used for a protein molecule that assists in the proper folding of other proteins? A) tertiary protein B) chaperonin C) enzyme protein D) renaturing protein E) denaturing protein",
        "back": "B"
    },
    {
    ...
    {
        "front": "One of the primary functions of RNA molecules is to A) transmit genetic information to offspring. B) function in the synthesis of proteins. C) make a copy of itself, thus ensuring genetic continuity. D) act as a pattern or blueprint to form DNA. E) form the genes of higher organisms.",
        "back": "B"
    },
    {
        "front": "If \u00b9\u2074C-labeled uridine triphosphate is added to the growth medium of cells, what macromolecules will be labeled? A) phospholipids B) DNA C) RNA D) both DNA and RNA E) proteins",
        "back": "C"
    },
    {
    ...
    {
        "front": "Which of the following are nitrogenous bases of the pyrimidine type? A) guanine and adenine B) cytosine and uracil C) thymine and guanine D) ribose and deoxyribose E) adenine and thymine",
        "back": "B"
    },
    {
        "front": "Which of the following are nitrogenous bases of the purine type? A) cytosine and guanine B) guanine and adenine C) adenine and thymine D) thymine and uracil E) uracil and cytosine",
        "back": "B"
    },
    {
        "front": "If a DNA sample were composed of 10% thymine, what would be the percentage of guanine? A) 10 B) 20 C) 40 D) 80 E) impossible to tell from the information given",
        "back": "C"
    },
    {
    ...
    {
        "front": "If one strand of a DNA molecule has the sequence of bases 5'ATTGCA3', the other complementary strand would have the sequence A) 5'TAACGT3'. B) 5'TGCAAT3'. C) 5'UAACGU3'. D) 3'UAACGU5'. E) 5'UGCAAU3'.",
        "back": "B"
    },
    {
        "front": "What is the structural feature that allows DNA to replicate? A) sugar-phosphate backbone B) complementary pairing of the nitrogenous bases C) disulfide bonding (bridging) of the two helixes D) twisting of the molecule to form an \u03b1 helix E) three-component structure of the nucleotides",
        "back": "B"
    },
    {
    ...
    {
        "front": "If cells are grown in a medium containing radioactive \u00b3\u00b2P-labeled phosphate, which of these molecules will be labeled? A) phospholipids B) nucleic acids C) proteins D) amylose E) both phospholipids and nucleic acids",
        "back": "E"
    },
    {
        "front": "If cells are grown in a medium containing radioactive \u00b9\u2075N, which of these molecules will be labeled? A) fatty acids only B) nucleic acids only C) proteins only D) amylase only E) both proteins and nucleic acids",
        "back": "E"
    },
    {
    ...
    {
        "front": "Which of the following is not a monomer/polymer pairing? A) monosaccharide/polysaccharide B) amino acid/protein C) triglyceride/phospholipid bilayer D) deoxyribonucleotide/DNA E) ribonucleotide/RNA",
        "back": "C"
    },
    {
        "front": "card image If two molecules of the general type shown in Figure 5.1 were linked together, carbon-1 of one molecule to carbon-4 of the other, the single molecule that would result would be A) maltose. B) fructose. C) glucose. D) galactose. E) sucrose.",
        "back": "A"
    },
    {
        "front": "card image Which of the following descriptors is true of the molecule shown in Figure 5.1? A) hexose B) fructose C) glucose D) hexose and fructose only E) hexose and glucose only",
        "back": "E"
    },
    {
    ...
    {
        "front": "card image The molecule shown in Figure 5.3 is a A) polysaccharide. B) polypeptide. C) saturated fatty acid. D) triacylglycerol. E) unsaturated fatty acid.",
        "back": "E"
    },
    {
        "front": "card image What is the structure shown in Figure 5.4? A) pentose molecule B) fatty acid molecule C) steroid molecule D) oligosaccharide molecule E) phospholipid molecule",
        "back": "C"
    },
    {
    ...
    {
        "front": "card image At which bond would water need to be added to achieve hydrolysis of the peptide, back to its component amino acid? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
    ...
    {
        "front": "card image Which bond is closest to the amino terminus of the molecule? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
    ...
    {
        "front": "card image Which molecule has both hydrophilic and hydrophobic properties and would be found in plasma membranes? A) 1 B) 5 C) 6 D) 12 E) 14",
        "back": "B"
    },
    {
        "front": "card image Which of the following combinations could be linked together to form a nucleotide? A) 1, 2, and 11 B) 3, 7, and 8 C) 5, 9, and 10 D) 11, 12, and 13 E) 12, 14, and 15",
        "back": "D"
    },
    {
        "front": "card image Which of the following molecules contain(s) an aldehyde type of carbonyl functional group? A) 1 B) 4 C) 8 D) 10 E) 1 and 4",
        "back": "E"
    },
    {
    ...
    {
        "front": "card image Which molecule is a saturated fatty acid? A) 1 B) 5 C) 6 D) 8 E) 9",
        "back": "E"
    },
    {
        "front": "card image Which of the following molecules is a purine type of nitrogenous base? A) 2 B) 3 C) 5 D) 12 E) 13",
        "back": "E"
    },
    {
        "front": "card image Which of the following molecules act as building blocks (monomers) of polypeptides? A) 1, 4, and 6 B) 2, 7, and 8 C) 7, 8, and 13 D) 11, 12, and 13 E) 12, 13, and 15",
        "back": "B"
    },
    {
        "front": "card image Which of the following molecules is an amino acid with a hydrophobic R group or side chain? A) 3 B) 7 C) 8 D) 12 E) 13",
        "back": "B"
    },
    {
        "front": "card image Which of the following molecules could be joined together by a peptide bond as a result of a dehydration reaction? A) 2 and 3 B) 3 and 7 C) 7 and 8 D) 8 and 9 E) 12 and 13",
        "back": "C"
    },
    {
    ...
    {
        "front": "card image Which of the following molecules could be joined together by a phosphodiester type of covalent bond? A) 3 and 4 B) 3 and 8 C) 6 and 15 D) 11 and 12 E) 11 and 13",
        "back": "D"
    },
    {
        "front": "card image Which of the following molecules is the pentose sugar found in RNA? A) 1 B) 4 C) 6 D) 12 E) 13",
        "back": "D"
    },
    {
        "front": "card image Which of the following molecules contains a glycosidic linkage type of covalent bond? A) 4 B) 6 C) 12 D) 13 E) 15",
        "back": "E"
    },
    {
        "front": "card image Which of the following molecules has a functional group that frequently forms covalent bonds that maintain the tertiary structure of a protein? A) 2 B) 3 C) 7 D) 8 E) 9",
        "back": "A"
    },
    {
        "front": "card image Which of the following molecules consists of a hydrophilic \"head\" region and a hydrophobic \"tail\" region? A) 2 B) 5 C) 7 D) 9 E) 11",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which class of biological polymer has the greatest functional variety? A) polysaccharides B) proteins C) DNA D) RNA",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of the following categories includes all others in the list? A) monosaccharide B) disaccharide C) starch D) carbohydrate E) polysaccharide",
        "back": "D"
    },
    {
    ...
    {
        "front": "The structural level of a protein least affected by a disruption in hydrogen bonding is the A) primary level. B) secondary level. C) tertiary level. D) quaternary level. E) All structural levels are equally affected.",
        "back": "A"
    },
    {
    ...
    {
        "front": "The molecular formula for glucose is C\u2086H\u2081\u2082O\u2086. What would be the molecular formula for a polymer made by linking ten glucose molecules together by dehydration reactions? A) C\u2086\u2080H\u2081\u2082\u2080O\u2086\u2080 B) C\u2086H\u2081\u2082O\u2086 C) C\u2086\u2080H\u2081\u2080\u2082O\u2085\u2081 D) C\u2086\u2080H\u2081\u2080\u2080O\u2085\u2080 E) C\u2086\u2080H\u2081\u2081\u2081O\u2085\u2081",
        "back": "C"
    },
    {
    ...
    {
        "front": "Who was/were the first to propose that cell membranes are phospholipid bilayers? A) H. Davson and J. Danielli B) I. Langmuir C) C. Overton D) S. Singer and G. Nicolson E) E. Gorter and F. Grendel",
        "back": "E"
    },
    {
    ...
    {
        "front": "Which of the following types of molecules are the major structural components of the cell membrane? A) phospholipids and cellulose B) nucleic acids and proteins C) phospholipids and proteins D) proteins and cellulose E) glycoproteins and cholesterol",
        "back": "C"
    },
    {
    ...
    {
        "front": "In order for a protein to be an integral membrane protein it would have to be A) hydrophilic. B) hydrophobic. C) amphipathic, with at least one hydrophobic region. D) completely covered with phospholipids. E) exposed on only one surface of the membrane.",
        "back": "C"
    },
    {
    ...
    {
        "front": "Which of the following is true of integral membrane proteins? A) They lack tertiary structure. B) They are loosely bound to the surface of the bilayer. C) They are usually transmembrane proteins. D) They are not mobile within the bilayer. E) They serve only a structural role in membranes.",
        "back": "C"
    },
    {
    ...
    {
        "front": "A protein that spans the phospholipid bilayer one or more times is A) a transmembrane protein. B) an integral protein. C) a peripheral protein. D) an integrin. E) a glycoprotein.",
        "back": "A"
    },
    {
        "front": "Which of these are not embedded in the hydrophobic portion of the lipid bilayer at all? A) transmembrane proteins B) integral proteins C) peripheral proteins D) integrins E) glycoproteins",
        "back": "C"
    },
    {
        "front": "The cell membranes of Antarctic ice fish might have which of the following adaptations? A) very long chain fatty acids B) branched isoprenoid lipids C) a high percentage of polyunsaturated fatty acids D) a higher percentage of trans-fatty acids E) no cholesterol",
        "back": "C"
    },
    {
        "front": "In a paramecium, cell surface integral membrane proteins are synthesized A) in the cytoplasm by free ribosomes. B) by ribosomes in the nucleus. C) by ribosomes bound to the rough endoplasmic reticulum. D) by ribosomes in the Golgi vesicles. E) by ribosomes bound to the inner surface of the plasma membrane.",
        "back": "C"
    },
    {
        "front": "The formulation of a model for a structure or for a process serves which of the following purposes? A) It asks a scientific question. B) It functions as a testable hypothesis. C) It records observations. D) It serves as a data point among results. E) It can only be arrived at after years of experimentation.",
        "back": "B"
    },
    {
    ...
    {
        "front": "What kinds of molecules pass through a cell membrane most easily? A) large and hydrophobic B) small and hydrophobic C) large polar D) ionic E) monosaccharides such as glucose",
        "back": "B"
    },
    {
    ...
    {
        "front": "Nitrous oxide gas molecules diffusing across a cell's plasma membrane is an example of A) diffusion across the lipid bilayer. B) facilitated diffusion. C) active transport. D) osmosis. E) cotransport.",
        "back": "A"
    },
    {
        "front": "Which of the following would likely move through the lipid bilayer of a plasma membrane most rapidly? A) CO\u2082 B) an amino acid C) glucose D) K\u207a E) starch",
        "back": "A"
    },
    {
    ...
    {
        "front": "Water passes quickly through cell membranes because A) the bilayer is hydrophilic. B) it moves through hydrophobic channels. C) water movement is tied to ATP hydrolysis. D) it is a small, polar, charged molecule. E) it moves through aquaporins in the membrane.",
        "back": "E"
    },
    {
    ...
    {
        "front": "When a plant cell, such as one from a peony stem, is submerged in a very hypotonic solution, what is likely to occur? A) The cell will burst. B) The cell membrane will lyse. C) Plasmolysis will shrink the interior. D) The cell will become flaccid. E) The cell will become turgid.",
        "back": "E"
    },
    {
    ...
    {
        "front": "What is the voltage across a membrane called? A) water potential B) chemical gradient C) membrane potential D) osmotic potential E) electrochemical gradient",
        "back": "C"
    },
    {
    ...
    {
        "front": "The movement of potassium into an animal cell requires A) low cellular concentrations of sodium. B) high cellular concentrations of potassium. C) an energy source such as ATP. D) a cotransport protein. E) a potassium channel protein.",
        "back": "C"
    },
    {
        "front": "Ions diffuse across membranes through specific ion channels A) down their chemical gradients. B) down their concentration gradients. C) down the electrical gradients. D) down their electrochemical gradients. E) down the osmotic potential gradients.",
        "back": "D"
    },
    {
        "front": "Which of the following would increase the electrochemical potential across a membrane? A) a chloride channel B) a sucrose-proton cotransporter C) a proton pump D) a potassium channel E) both a proton pump and a potassium channel",
        "back": "C"
    },
    {
    ...
    {
        "front": "An organism with a cell wall would most likely be unable to take in materials through A) diffusion. B) osmosis. C) active transport. D) phagocytosis. E) facilitated diffusion.",
        "back": "D"
    },
    {
        "front": "White blood cells engulf bacteria through what process? A) exocytosis B) phagocytosis C) pinocytosis D) osmosis E) receptor-mediated exocytosis",
        "back": "B"
    },
    {
    ...
    {
        "front": "In receptor-mediated endocytosis, receptor molecules initially project to the outside of the cell. Where do they end up after endocytosis? A) on the outside of vesicles B) on the inside surface of the cell membrane C) on the inside surface of the vesicle D) on the outer surface of the nucleus E) on the ER",
        "back": "C"
    },
    {
        "front": "A bacterium engulfed by a white blood cell through phagocytosis will be digested by enzymes contained in A) peroxisomes. B) lysosomes. C) Golgi vesicles. D) vacuoles. E) secretory vesicles.",
        "back": "B"
    },
    {
        "front": "card image Which component is the peripheral protein? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
        "front": "card image Which component is cholesterol? A) A B) B C) C D) D E) E",
        "back": "E"
    },
    {
        "front": "card image Which component is the fiber of the extracellular matrix? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
        "front": "card image Which component is a microfilament of the cytoskeleton? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "card image Which component is a glycolipid? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
    ...
    {
        "front": "card image Which line in the graph represents the bag with the highest initial concentration of sucrose? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
        "front": "card image Which line or lines in the graph represent(s) bags that contain a solution that is hypertonic at 50 minutes? A) A and B B) B C) C D) D E) D and E",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of the following processes includes all others? A) osmosis B) diffusion of a solute across a membrane C) facilitated diffusion D) passive transport E) transport of an ion down its electrochemical gradient",
        "back": "D"
    },
    {
    ...
    {
        "front": "Which term most precisely describes the cellular process of breaking down large molecules into smaller ones? A) catalysis B) metabolism C) anabolism D) dehydration E) catabolism",
        "back": "E"
    },
    {
    ...
    {
        "front": "Whenever energy is transformed, there is always an increase in the A) free energy of the system. B) free energy of the universe. C) entropy of the system. D) entropy of the universe. E) enthalpy of the universe.",
        "back": "D"
    },
    {
    ...
    {
        "front": "Which of the following types of reactions would decrease the entropy within a cell? A) anabolic reactions B) hydrolysis C) respiration D) digestion E) catabolic reactions",
        "back": "A"
    },
    {
    ...
    {
        "front": "Which of the following is an example of potential rather than kinetic energy? A) the muscle contractions of a person mowing grass B) water rushing over Niagara Falls C) light flashes emitted by a firefly D) a molecule of glucose E) the flight of an insect foraging for food",
        "back": "D"
    },
    {
        "front": "Which of the following is the smallest closed system? A) a cell B) an organism C) an ecosystem D) Earth E) the universe",
        "back": "E"
    },
    {
    ...
    {
        "front": "A system at chemical equilibrium A) consumes energy at a steady rate. B) releases energy at a steady rate. C) consumes or releases energy, depending on whether it is exergonic or endergonic. D) has zero kinetic energy. E) can do no work.",
        "back": "E"
    },
    {
    ...
    {
        "front": "Which of the following shows the correct changes in thermodynamic properties for a chemical reaction in which amino acids are linked to form a protein? A) +\u0394H, +\u0394S, +\u0394G B) +\u0394H, -\u0394S, -\u0394G C) +\u0394H, -\u0394S, +\u0394G D) -\u0394H, -\u0394S, +\u0394G E) -\u0394H, +\u0394S, +\u0394G",
        "back": "C"
    },
    {
        "front": "When glucose monomers are joined together by glycosidic linkages to form a cellulose polymer, the changes in free energy, total energy, and entropy are as follows: A) +\u0394G, +\u0394H, +\u0394S. B) +\u0394G, +\u0394H, -\u0394S. C) +\u0394G, -\u0394H, -\u0394S. D) -\u0394G, +\u0394H, +\u0394S. E) -\u0394G, -\u0394H, -\u0394S.",
        "back": "B"
    },
    {
        "front": "A chemical reaction that has a positive \u0394G is correctly described as A) endergonic. B) endothermic. C) enthalpic. D) spontaneous. E) exothermic.",
        "back": "A"
    },
    {
        "front": "Which of the following best describes enthalpy (H)? A) the total kinetic energy of a system B) the heat content of a chemical system C) the system's entropy D) the cell's energy equilibrium E) the condition of a cell that is not able to react",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of the following is most similar in structure to ATP? A) a pentose sugar B) a DNA nucleotide C) an RNA nucleotide D) an amino acid with three phosphate groups attached E) a phospholipid",
        "back": "C"
    },
    {
    ...
    {
        "front": "Reactants capable of interacting to form products in a chemical reaction must first overcome a thermodynamic barrier known as the reaction's A) entropy. B) activation energy. C) endothermic level. D) equilibrium point. E) free-energy content.",
        "back": "B"
    },
    {
    ...
    {
        "front": "During a laboratory experiment, you discover that an enzyme-catalyzed reaction has a \u2206G of -20 kcal/mol. If you double the amount of enzyme in the reaction, what will be the \u2206G for the new reaction? A) -40 kcal/mol B) -20 kcal/mol C) 0 kcal/mol D) +20 kcal/mol E) +40 kcal/mol",
        "back": "B"
    },
    {
        "front": "The active site of an enzyme is the region that A) binds allosteric regulators of the enzyme. B) is involved in the catalytic reaction of the enzyme. C) binds noncompetitive inhibitors of the enzyme. D) is inhibited by the presence of a coenzyme or a cofactor.",
        "back": "B"
    },
    {
    ...
    {
        "front": "Increasing the substrate concentration in an enzymatic reaction could overcome which of the following? A) denaturization of the enzyme B) allosteric inhibition C) competitive inhibition D) saturation of the enzyme activity E) insufficient cofactors",
        "back": "C"
    },
    {
    ...
    {
        "front": "The mechanism in which the end product of a metabolic pathway inhibits an earlier step in the pathway is most precisely described as A) metabolic inhibition. B) feedback inhibition. C) allosteric inhibition. D) noncooperative inhibition. E) reversible inhibition.",
        "back": "B"
    },
    {
    ...
    {
        "front": "Allosteric enzyme regulation is usually associated with A) lack of cooperativity. B) feedback inhibition. C) activating activity. D) an enzyme with more than one subunit. E) the need for cofactors.",
        "back": "D"
    },
    {
    ...
    {
        "front": "card image Which curve(s) on the graphs may represent the temperature and pH profiles of an enzyme taken from a bacterium that lives in a mildly alkaline hot springs at temperatures of 70\u00b0C or higher? A) curves 1 and 5 B) curves 2 and 4 C) curves 2 and 5 D) curves 3 and 4 E) curves 3 and 5",
        "back": "E"
    },
    {
        "front": "card image Which temperature and pH profile curves on the graphs were most likely generated from analysis of an enzyme from a human stomach where conditions are strongly acid? A) curves 1 and 4 B) curves 1 and 5 C) curves 2 and 4 D) curves 2 and 5 E) curves 3 and 4",
        "back": "A"
    },
    {
        "front": "card image This question is based on the reaction A + B \u2194 C + D shown in the figure.   Which of the following terms best describes the forward reaction in Figure 8.1? A) endergonic, \u2206G > 0 B) exergonic, \u2206G < 0 C) endergonic, \u2206G < 0 D) exergonic, \u2206G > 0 E) chemical equilibrium, \u2206G = 0",
        "back": "B"
    },
    {
        "front": "card image This question is based on the reaction A + B \u2194 C + D shown in the figure.   Which of the following represents the \u0394G of the reaction in Figure 8.1? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
        "front": "card image This question is based on the reaction A + B \u2194 C + D shown in the figure.   Which of the following in Figure 8.1 would be the same in either an enzyme-catalyzed or a noncatalyzed reaction? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
        "front": "card image This question is based on the reaction A + B \u2194 C + D shown in the figure.   Which of the following represents the activation energy needed for the enzyme-catalyzed reverse reaction, C + D \u2192 A + B, in Figure 8.1? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
        "front": "card image This question is based on the reaction A + B \u2194 C + D shown in the figure.   Which of the following represents the difference between the free-energy content of the reaction and the free-energy content of the products in Figure 8.1? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
        "front": "card image This question is based on the reaction A + B \u2194 C + D shown in the figure.   Which of the following represents the activation energy required for the enzyme-catalyzed reaction in Figure 8.1? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
        "front": "card image This question is based on the reaction A + B \u2194 C + D shown in the figure.   Which of the following represents the activation energy required for a noncatalyzed reaction in Figure 8.1? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "card image This question is based on the reaction A + B \u2194 C + D shown in the figure.   Which of the following represents the activation energy needed for the noncatalyzed reverse reaction, C + D \u2192 A + B, in Figure 8.1? A) A B) B C) C D) D E) E",
        "back": "E"
    },
    {
    ...
    {
        "front": "Choose the pair of terms that correctly completes this sentence: Catabolism is to anabolism as ________ is to ________. A) exergonic; spontaneous B) exergonic; endergonic C) free energy; entropy D) work; energy E) entropy; enthalpy",
        "back": "B"
    },
    {
        "front": "Most cells cannot harness heat to perform work because A) heat is not a form of energy. B) cells do not have much heat; they are relatively cool. C) temperature is usually uniform throughout a cell. D) heat can never be used to do work. E) heat must remain constant during work.",
        "back": "C"
    },
    {
        "front": "Which of the following metabolic processes can occur without a net influx of energy from some other process? A) ADP + Pi \u2192 ATP + H\u2082O B) C\u2086H\u2081\u2082O\u2086 + 6 O\u2082 \u2192 6 CO\u2082 + 6 H\u2082O C) 6 CO\u2082 + 6 H\u2082O \u2192 C\u2086H\u2081\u2082O\u2086 + 6 O\u2082 D) amino acids \u2192 protein E) glucose + fructose \u2192 sucrose",
        "back": "B"
    },
    {
        "front": "If an enzyme in solution is saturated with substrate, the most effective way to obtain a faster yield of products is to A) add more of the enzyme. B) heat the solution to 90\u00b0C. C) add more substrate. D) add an allosteric inhibitor. E) add a noncompetitive inhibitor.",
        "back": "A"
    },
    {
    ...
    {
        "front": "What is the term for metabolic pathways that release stored energy by breaking down complex molecules? A) anabolic pathways B) catabolic pathways C) fermentation pathways D) thermodynamic pathways E) bioenergetic pathways",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of the following statements describes the results of this reaction? C\u2086H\u2081\u2082O\u2086 + 6 O\u2082 \u2192 6 CO\u2082 + 6 H\u2082O + Energy A) C\u2086H\u2081\u2082O\u2086 is oxidized and O\u2082 is reduced. B) O\u2082 is oxidized and H\u2082O is reduced. C) CO\u2082 is reduced and O\u2082 is oxidized. D) C\u2086H\u2081\u2082O\u2086 is reduced and CO\u2082 is oxidized. E) O\u2082 is reduced and CO\u2082 is oxidized.",
        "back": "A"
    },
    {
        "front": "When a glucose molecule loses a hydrogen atom as the result of an oxidation-reduction reaction, the molecule becomes A) hydrolyzed. B) hydrogenated. C) oxidized. D) reduced. E) an oxidizing agent.",
        "back": "C"
    },
    {
        "front": "When a molecule of NAD\u207a (nicotinamide adenine dinucleotide) gains a hydrogen atom (not a proton), the molecule becomes A) dehydrogenated. B) oxidized. C) reduced. D) redoxed. E) hydrolyzed.",
        "back": "C"
    },
    {
    ...
    {
        "front": "Where does glycolysis take place in eukaryotic cells? A) mitochondrial matrix B) mitochondrial outer membrane C) mitochondrial inner membrane D) mitochondrial intermembrane space E) cytosol",
        "back": "E"
    },
    {
        "front": "The ATP made during glycolysis is generated by A) substrate-level phosphorylation. B) electron transport. C) photophosphorylation. D) chemiosmosis. E) oxidation of NADH to NAD\u207a.",
        "back": "A"
    },
    {
        "front": "The oxygen consumed during cellular respiration is involved directly in which process or event? A) glycolysis B) accepting electrons at the end of the electron transport chain C) the citric acid cycle D) the oxidation of pyruvate to acetyl CoA E) the phosphorylation of ADP to form ATP",
        "back": "B"
    },
    {
        "front": "Which process in eukaryotic cells will proceed normally whether oxygen (O\u2082) is present or absent? A) electron transport B) glycolysis C) the citric acid cycle D) oxidative phosphorylation E) chemiosmosis",
        "back": "B"
    },
    {
        "front": "An electron loses potential energy when it A) shifts to a less electronegative atom. B) shifts to a more electronegative atom. C) increases its kinetic energy. D) increases its activity as an oxidizing agent. E) moves further away from the nucleus of the atom.",
        "back": "B"
    },
    {
        "front": "Why are carbohydrates and fats considered high energy foods? A) They have a lot of oxygen atoms. B) They have no nitrogen in their makeup. C) They can have very long carbon skeletons. D) They have a lot of electrons associated with hydrogen. E) They are easily reduced.",
        "back": "D"
    },
    {
        "front": "Substrate-level phosphorylation accounts for approximately what percentage of the ATP formed by the reactions of glycolysis? A) 0% B) 2% C) 10% D) 38% E) 100%",
        "back": "E"
    },
    {
    ...
    {
        "front": "In addition to ATP, what are the end products of glycolysis? A) CO\u2082 and H\u2082O B) CO\u2082 and pyruvate C) NADH and pyruvate D) CO\u2082 and NADH E) H\u2082O, FADH\u2082, and citrate",
        "back": "C"
    },
    {
    ...
    {
        "front": "Starting with one molecule of glucose, the energy-containing products of glycolysis are A) 2 NAD\u207a, 2 pyruvate, and 2 ATP. B) 2 NADH, 2 pyruvate, and 2 ATP. C) 2 FADH\u2082, 2 pyruvate, and 4 ATP. D) 6 CO\u2082, 2 ATP, and 2 pyruvate. E) 6 CO\u2082, 30 ATP, and 2 pyruvate.",
        "back": "B"
    },
    {
    ...
    {
        "front": "The transport of pyruvate into mitochondria depends on the proton-motive force across the inner mitochondrial membrane. How does pyruvate enter the mitochondrion? A) active transport B) diffusion C) facilitated diffusion D) through a channel E) through a pore",
        "back": "A"
    },
    {
        "front": "Which of the following intermediary metabolites enters the citric acid cycle and is formed, in part, by the removal of a carbon (CO\u2082) from one molecule of pyruvate? A) lactate B) glyceraldehydes-3-phosphate C) oxaloacetate D) acetyl CoA E) citrate",
        "back": "D"
    },
    {
        "front": "During cellular respiration, acetyl CoA accumulates in which location? A) cytosol B) mitochondrial outer membrane C) mitochondrial inner membrane D) mitochondrial intermembrane space E) mitochondrial matrix",
        "back": "E"
    },
    {
        "front": "How many carbon atoms are fed into the citric acid cycle as a result of the oxidation of one molecule of pyruvate? A) two B) four C) six D) eight E) ten",
        "back": "A"
    },
    {
    ...
    {
        "front": "During aerobic respiration, electrons travel downhill in which sequence? A) food \u2192 citric acid cycle \u2192 ATP \u2192 NAD\u207a B) food \u2192 NADH \u2192 electron transport chain \u2192 oxygen C) glucose \u2192 pyruvate \u2192 ATP \u2192 oxygen D) glucose \u2192 ATP \u2192 electron transport chain \u2192 NADH E) food \u2192 glycolysis \u2192 citric acid cycle \u2192 NADH \u2192 ATP",
        "back": "B"
    },
    {
        "front": "What fraction of the carbon dioxide exhaled by animals is generated by the reactions of the citric acid cycle, if glucose is the sole energy source? A) 1/6 B) 1/3 C) 1/2 D) 2/3 E) 100/100",
        "back": "D"
    },
    {
        "front": "Where are the proteins of the electron transport chain located? A) cytosol B) mitochondrial outer membrane C) mitochondrial inner membrane D) mitochondrial intermembrane space E) mitochondrial matrix",
        "back": "C"
    },
    {
    ...
    {
        "front": "During aerobic respiration, which of the following directly donates electrons to the electron transport chain at the lowest energy level? A) NAD+ B) NADH C) ATP D) ADP + Pi E) FADH2",
        "back": "E"
    },
    {
    ...
    {
        "front": "During aerobic respiration, H\u2082O is formed. Where does the oxygen atom for the formation of the water come from? A) carbon dioxide (CO\u2082) B) glucose (C\u2086H\u2081\u2082O\u2086) C) molecular oxygen (O\u2082) D) pyruvate (C\u2083H\u2083O\u2083-) E) lactate (C\u2083H\u2085O\u2083-)",
        "back": "C"
    },
    {
    ...
    {
        "front": "Energy released by the electron transport chain is used to pump H\u207a into which location in eukaryotic cells? A) cytosol B) mitochondrial outer membrane C) mitochondrial inner membrane D) mitochondrial intermembrane space E) mitochondrial matrix",
        "back": "D"
    },
    {
    ...
    {
        "front": "Where is ATP synthase located in the mitochondrion? A) cytosol B) electron transport chain C) outer membrane D) inner membrane E) mitochondrial matrix",
        "back": "D"
    },
    {
    ...
    {
        "front": "How many oxygen molecules (O\u2082) are required each time a molecule of glucose (C\u2086H\u2081\u2082O\u2086) is completely oxidized to carbon dioxide and water via aerobic respiration,? A) 1 B) 3 C) 6 D) 12 E) 30",
        "back": "C"
    },
    {
        "front": "Which of the following produces the most ATP when glucose (C\u2086H\u2081\u2082O\u2086) is completely oxidized to carbon dioxide (CO\u2082) and water? A) glycolysis B) fermentation C) oxidation of pyruvate to acetyl CoA D) citric acid cycle E) oxidative phosphorylation (chemiosmosis)",
        "back": "E"
    },
    {
        "front": "Approximately how many molecules of ATP are produced from the complete oxidation of two molecules of glucose (C\u2086H\u2081\u2082O\u2086) in aerobic cellular respiration? A) 2 B) 4 C) 15 D) 30-32 E) 60-64",
        "back": "E"
    },
    {
    ...
    {
        "front": "If a cell is able to synthesize 30 ATP molecules for each molecule of glucose completely oxidized by carbon dioxide and water, how many ATP molecules can the cell synthesize for each molecule of pyruvate oxidized to carbon dioxide and water? A) 0 B) 1 C) 12 D) 14 E) 15",
        "back": "C"
    },
    {
    ...
    {
        "front": "Which of the following normally occurs regardless of whether or not oxygen (O\u2082) is present? A) glycolysis B) fermentation C) oxidation of pyruvate to acetyl CoA D) citric acid cycle E) oxidative phosphorylation (chemiosmosis)",
        "back": "A"
    },
    {
        "front": "Which of the following occurs in the cytosol of a eukaryotic cell? A) glycolysis and fermentation B) fermentation and chemiosmosis C) oxidation of pyruvate to acetyl CoA D) citric acid cycle E) oxidative phosphorylation",
        "back": "A"
    },
    {
        "front": "Which metabolic pathway is common to both cellular respiration and fermentation? A) the oxidation of pyruvate to acetyl CoA B) the citric acid cycle C) oxidative phosphorylation D) glycolysis E) chemiosmosis",
        "back": "D"
    },
    {
        "front": "The ATP made during fermentation is generated by which of the following? A) the electron transport chain B) substrate-level phosphorylation C) chemiosmosis D) oxidative phosphorylation E) aerobic respiration",
        "back": "B"
    },
    {
        "front": "In the absence of oxygen, yeast cells can obtain energy by fermentation, resulting in the production of A) ATP, CO\u2082, and ethanol (ethyl alcohol). B) ATP, CO\u2082, and lactate. C) ATP, NADH, and pyruvate. D) ATP, pyruvate, and oxygen. E) ATP, pyruvate, and acetyl CoA.",
        "back": "A"
    },
    {
        "front": "In alcohol fermentation, NAD\u207a is regenerated from NADH by A) reduction of acetaldehyde to ethanol (ethyl alcohol). B) oxidation of pyruvate to acetyl CoA. C) reduction of pyruvate to form lactate. D) oxidation of ethanol to acetyl CoA. E) reduction of ethanol to pyruvate.",
        "back": "A"
    },
    {
        "front": "One function of both alcohol fermentation and lactic acid fermentation is to A) reduce NAD\u207a to NADH. B) reduce FAD\u207a to FADH\u2082. C) oxidize NADH to NAD\u207a. D) reduce FADH\u2082 to FAD\u207a. E) do none of the above.",
        "back": "C"
    },
    {
    ...
    {
        "front": "When skeletal muscle cells undergo anaerobic respiration, they become fatigued and painful. This is now known to be caused by A) buildup of pyruvate. B) buildup of lactate. C) increase in sodium ions. D) increase in potassium ions. E) increase in ethanol.",
        "back": "B"
    },
    {
    ...
    {
        "front": "What is the purpose of beta oxidation in respiration? A) oxidation of glucose B) oxidation of pyruvate C) feedback regulation D) control of ATP accumulation E) breakdown of fatty acids",
        "back": "E"
    },
    {
        "front": "Where do the catabolic products of fatty acid breakdown enter into the citric acid cycle? A) pyruvate B) malate or fumarate C) acetyl CoA D) \u03b1-ketoglutarate E) succinyl CoA",
        "back": "C"
    },
    {
        "front": "What carbon sources can yeast cells metabolize to make ATP from ADP under anaerobic conditions? A) glucose B) ethanol C) pyruvate D) lactic acid E) either ethanol or lactic acid",
        "back": "A"
    },
    {
    ...
    {
        "front": "During intense exercise, as skeletal muscle cells go into anaerobiosis, the human body will increase its catabolism of A) fats only. B) carbohydrates only. C) proteins only. D) fats, carbohydrates, and proteins. E) fats and proteins only.",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which step in Figure 9.1 shows a split of one molecule into two smaller molecules? A) A B) B C) C D) D E) E",
        "back": "B"
    },
    {
        "front": "card image In which step in Figure 9.1 is an inorganic phosphate added to the reactant? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "card image Which step in Figure 9.1 is a redox reaction? A) A B) B C) C D) D E) E",
        "back": "C"
    },
    {
        "front": "card image Which portion of the pathway in Figure 9.1 involves an endergonic reaction? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
        "front": "card image Which portion of the pathway in Figure 9.1 contains a phosphorylation reaction in which ATP is the phosphate source? A) A B) B C) C D) D E) E",
        "back": "A"
    },
    {
        "front": "card image Starting with one molecule of isocitrate and ending with fumarate, how many ATP molecules can be made through substrate-level phosphorylation (see Figure 9.2)? A) 1 B) 2 C) 11 D) 12 E) 24",
        "back": "A"
    },
    {
        "front": "card image Carbon skeletons for amino acid biosynthesis are supplied by intermediates of the citric acid cycle. Which intermediate would supply the carbon skeleton for synthesis of a five-carbon amino acid (see Figure 9.2)? A) succinate B) malate C) citrate D) \u03b1-ketoglutarate E) isocitrate",
        "back": "D"
    },
    {
        "front": "card image For each mole of glucose (C\u2086H\u2081\u2082O\u2086) oxidized by cellular respiration, how many moles of CO\u2082 are released in the citric acid cycle (see Figure 9.2)? A) 2 B) 4 C) 6 D) 12 E) 3",
        "back": "B"
    },
    {
    ...
    {
        "front": "card image For each molecule of glucose that is metabolized by glycolysis and the citric acid cycle (see Figure 9.2), what is the total number of NADH + FADH\u2082 molecules produced? A) 4 B) 5 C) 6 D) 10 E) 12",
        "back": "E"
    },
    {
        "front": "card image Figure 9.3 shows the electron transport chain. Which of the following is the combination of substances that is initially added to the chain? A) oxygen, carbon dioxide, and water B) NAD\u207a, FAD, and electrons C) NADH, FADH\u2082, and protons D) NADH, FADH\u2082, and O\u2082 E) oxygen and protons",
        "back": "D"
    },
    {
    ...
    {
        "front": "card image Which of the protein complexes labeled with Roman numerals in Figure 9.3 will transfer electrons to O\u2082? A) complex I B) complex II C) complex III D) complex IV E) All of the complexes can transfer electrons to O\u2082.",
        "back": "D"
    },
    {
    ...
    {
        "front": "Which metabolic pathway is common to both fermentation and cellular respiration of a glucose molecule? A) the citric acid cycle B) the electron transport chain C) glycolysis D) synthesis of acetyl CoA from pyruvate E) reduction of pyruvate to lactate",
        "back": "C"
    },
    {
    ...
    {
        "front": "The final electron acceptor of the electron transport chain that functions in aerobic oxidative phosphorylation is A) oxygen. B) water. C) NAD\u207a. D) pyruvate. E) ADP.",
        "back": "A"
    },
    {
        "front": "What is the oxidizing agent in the following reaction? Pyruvate + NADH + H\u207a \u2192 Lactate + NAD\u207a A) oxygen B) NADH C) NAD\u207a D) lactate E) pyruvate",
        "back": "E"
    },
    {
        "front": "When electrons flow along the electron transport chains of mitochondria, which of the following changes occurs? A) The pH of the matrix increases. B) ATP synthase pumps protons by active transport. C) The electrons gain free energy. D) The cytochromes phosphorylate ADP to form ATP. E) NAD\u207a is oxidized.",
        "back": "A"
    },
    {
        "front": "Most CO\u2082 from catabolism is released during A) glycolysis. B) the citric acid cycle. C) lactate fermentation. D) electron transport. E) oxidative phosphorylation.",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of the following are products of the light reactions of photosynthesis that are utilized in the Calvin cycle? A) CO\u2082 and glucose B) H\u2082O and O\u2082 C) ADP, Pi, and NADP\u207a D) electrons and H\u207a E) ATP and NADPH",
        "back": "E"
    },
    {
        "front": "Photosynthesis is not responsible for A) oxygen in the atmosphere. B) the ozone layer. C) most of the organic carbon on Earth's surface. D) atmospheric CO\u2082. E) fossil fuels.",
        "back": "E"
    },
    {
        "front": "Where does the Calvin cycle take place? A) stroma of the chloroplast B) thylakoid membrane C) cytoplasm surrounding the chloroplast D) interior of the thylakoid (thylakoid space) E) outer membrane of the chloroplast",
        "back": "A"
    },
    {
        "front": "In any ecosystem, terrestrial or aquatic, what group(s) is (are) always necessary? A) autotrophs and heterotrophs B) producers and primary consumers C) photosynthesizers D) autotrophs E) green plants",
        "back": "D"
    },
    {
        "front": "In autotrophic bacteria, where are the enzymes located that can carry on carbon fixation (reduction of carbon dioxide to carbohydrate)? A) in chloroplast membranes B) in chloroplast stroma C) in the cytosol D) in the nucleoid E) in the infolded plasma membrane",
        "back": "C"
    },
    {
        "front": "When oxygen is released as a result of photosynthesis, it is a direct by-product of A) reducing NADP\u207a. B) splitting water molecules. C) chemiosmosis. D) the electron transfer system of photosystem I. E) the electron transfer system of photosystem II.",
        "back": "B"
    },
    {
        "front": "A plant has a unique photosynthetic pigment. The leaves of this plant appear to be reddish yellow. What wavelengths of visible light are being absorbed by this pigment? A) red and yellow B) blue and violet C) green and yellow D) blue, green, and red E) green, blue, and yellow",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of the events listed below occurs in the light reactions of photosynthesis? A) NADP is produced. B) NADPH is reduced to NADP\u207a. C) Carbon dioxide is incorporated into PGA. D) ATP is phosphorylated to yield ADP. E) Light is absorbed and funneled to reaction-center chlorophyll a.",
        "back": "E"
    },
    {
    ...
    {
        "front": "What are the products of linear photophosphorylation? A) heat and fluorescence B) ATP and P700 C) ATP and NADPH D) ADP and NADP E) P700 and P680",
        "back": "C"
    },
    {
    ...
    {
        "front": "In a plant cell, where are the ATP synthase complexes located? A) thylakoid membrane only B) plasma membrane only C) inner mitochondrial membrane only D) thylakoid membrane and inner mitochondrial membrane E) thylakoid membrane and plasma membrane",
        "back": "D"
    },
    {
    ...
    {
        "front": "Where are the molecules of the electron transport chain found in plant cells? A) thylakoid membranes of chloroplasts B) stroma of chloroplasts C) outer membrane of mitochondria D) matrix of mitochondria E) cytoplasm",
        "back": "A"
    },
    {
        "front": "In photosynthetic cells, synthesis of ATP by the chemiosmotic mechanism occurs during A) photosynthesis only. B) respiration only. C) both photosynthesis and respiration. D) neither photosynthesis nor respiration. E) photorespiration only.",
        "back": "C"
    },
    {
        "front": "Reduction of oxygen to form water occurs during A) photosynthesis only. B) respiration only. C) both photosynthesis and respiration. D) neither photosynthesis nor respiration. E) photorespiration only.",
        "back": "B"
    },
    {
        "front": "Reduction of NADP\u207a occurs during A) photosynthesis. B) respiration. C) both photosynthesis and respiration. D) neither photosynthesis nor respiration. E) photorespiration.",
        "back": "A"
    },
    {
        "front": "The splitting of carbon dioxide to form oxygen gas and carbon compounds occurs during A) photosynthesis. B) respiration. C) both photosynthesis and respiration. D) neither photosynthesis nor respiration. E) photorespiration.",
        "back": "D"
    },
    {
        "front": "Generation of proton gradients across membranes occurs during A) photosynthesis. B) respiration. C) both photosynthesis and respiration. D) neither photosynthesis nor respiration. E) photorespiration.",
        "back": "C"
    },
    {
        "front": "What is the relationship between wavelength of light and the quantity of energy per photon? A) They have a direct, linear relationship. B) They are inversely related. C) They are logarithmically related. D) They are separate phenomena. E) They are only related in certain parts of the spectrum.",
        "back": "B"
    },
    {
    ...
    {
        "front": "In a cyanobacterium, the reactions that produce NADPH occur in A) the light reactions alone. B) the Calvin cycle alone. C) both the light reactions and the Calvin cycle. D) neither the light reactions nor the Calvin cycle. E) the chloroplast, but is not part of photosynthesis.",
        "back": "A"
    },
    {
        "front": "The reactions that produce molecular oxygen (O\u2082) take place in A) the light reactions alone. B) the Calvin cycle alone. C) both the light reactions and the Calvin cycle. D) neither the light reactions nor the Calvin cycle. E) the chloroplast, but are not part of photosynthesis.",
        "back": "A"
    },
    {
    ...
    {
        "front": "Where do the enzymatic reactions of the Calvin cycle take place? A) stroma of the chloroplast B) thylakoid membranes C) matrix of the mitochondria D) cytosol around the chloroplast E) thylakoid space",
        "back": "A"
    },
    {
        "front": "What is the primary function of the Calvin cycle? A) use ATP to release carbon dioxide B) use NADPH to release carbon dioxide C) split water and release oxygen D) transport RuBP out of the chloroplast E) synthesize simple sugars from carbon dioxide",
        "back": "E"
    },
    {
        "front": "In C\u2083 photosynthesis, the reactions that require ATP take place in A) the light reactions alone. B) the Calvin cycle alone. C) both the light reactions and the Calvin cycle. D) neither the light reactions nor the Calvin cycle. E) the chloroplast, but is not part of photosynthesis.",
        "back": "B"
    },
    {
        "front": "In a plant leaf, the reactions that produce NADH occur in A) the light reactions alone. B) the Calvin cycle alone. C) both the light reactions and the Calvin cycle. D) neither the light reactions nor the Calvin cycle. E) the chloroplast, but is not part of photosynthesis.",
        "back": "D"
    },
    {
        "front": "The NADPH required for the Calvin cycle comes from A) reactions initiated in photosystem I. B) reactions initiated in photosystem II. C) the citric acid cycle. D) glycolysis. E) oxidative phosphorylation.",
        "back": "A"
    },
    {
        "front": "Reactions that require CO\u2082 take place in A) the light reactions alone. B) the Calvin cycle alone. C) both the light reactions and the Calvin cycle. D) neither the light reactions nor the Calvin cycle. E) the chloroplast, but is not part of photosynthesis.",
        "back": "B"
    },
    {
    ...
    {
        "front": "The phylogenetic distribution of the enzyme rubisco is limited to A) C\u2083 plants only. B) C\u2083 and C\u2084 plants. C) all photosynthetic eukaryotes. D) all known photoautotrophs, both bacterial and eukaryotic. E) all living cells.",
        "back": "D"
    },
    {
        "front": "Photorespiration occurs when rubisco reacts RuBP with A) CO\u2082. B) O\u2082. C) glyceraldehyde 3-phosphate. D) 3-phosphoglycerate. E) NADPH.",
        "back": "B"
    },
    {
        "front": "In an experiment studying photosynthesis performed during the day, you provide a plant with radioactive carbon (\u00b9\u2074C) dioxide as a metabolic tracer. The \u00b9\u2074C is incorporated first into oxaloacetate. The plant is best characterized as a A) C\u2084 plant. B) C\u2083 plant. C) CAM plant. D) heterotroph. E) chemoautotroph.",
        "back": "A"
    },
    {
        "front": "Why are C\u2084 plants able to photosynthesize with no apparent photorespiration? A) They do not participate in the Calvin cycle. B) They use PEP carboxylase to initially fix CO\u2082. C) They are adapted to cold, wet climates. D) They conserve water more efficiently. E) They exclude oxygen from their tissues.",
        "back": "B"
    },
    {
    ...
    {
        "front": "Photorespiration lowers the efficiency of photosynthesis by A) carbon dioxide molecules. B) 3-phosphoglycerate molecules. C) ATP molecules. D) ribulose bisphosphate molecules. E) RuBP carboxylase molecules.",
        "back": "B"
    },
    {
    ...
    {
        "front": "Compared to C\u2083 plants, C\u2084 plants A) can continue to fix CO\u2082 even at relatively low CO2 concentrations and high oxygen concentrations. B) have higher rates of photorespiration. C) do not use rubisco for carbon fixation. D) grow better under cool, moist conditions. E) make a four-carbon compound, oxaloacetate, which is then delivered to the citric acid cycle in mitochondria.",
        "back": "A"
    },
    {
    ...
    {
        "front": "Plants photosynthesize only in the light. Plants respire A) in the dark only. B) in the light only. C) both in light and dark. D) never\u2013they get their ATP from photophosphorylation. E) only when excessive light energy induces photorespiration.",
        "back": "C"
    },
    {
    ...
    {
        "front": "card image What wavelength of light in the figure is most effective in driving photosynthesis? A) 420 mm B) 475 mm C) 575 mm D) 625 mm E) 730 mm",
        "back": "A"
    },
    {
        "front": "card image If ATP used by this plant is labeled with radioactive phosphorus, which molecule or molecules of the Calvin cycle will be radioactively labeled first? A) B only B) B and C only C) B, C, and D only D) B and E only E) B, C, D, and E",
        "back": "D"
    },
    {
        "front": "card image If the carbon atom of the incoming CO\u2082 molecule is labeled with a radioactive isotope of carbon, which organic molecules will be radioactively labeled after one cycle? A) C only B) B, C, D, and E C) C, D, and E only D) B and C only E) B and D only",
        "back": "B"
    },
    {
        "front": "card image Which molecule(s) of the Calvin cycle is (are) also found in glycolysis? A) B, C, E, and 3-phosphoglycerate B) B, C, and E only C) 3-phosphoglycerate only D) B, C, D, and 3-phosphoglycerate only E) E only",
        "back": "D"
    },
    {
    ...
    {
        "front": "card image Referring to Figure 10.3, oxygen would inhibit the CO\u2082 fixation reactions in A) cell I only. B) cell II only. C) neither cell I nor cell II. D) both cell I and cell II. E) cell I during the night and cell II during the day.",
        "back": "B"
    },
    {
    ...
    {
        "front": "The light reactions of photosynthesis supply the Calvin cycle with A) light energy. B) CO\u2082 and ATP. C) H\u2082O and NADPH. D) ATP and NADPH. E) sugar and O\u2082.",
        "back": "D"
    },
    {
        "front": "Which of the following sequences correctly represents the flow of electrons during photosynthesis? A) NADPH \u2192 O\u2082 \u2192 CO\u2082 B) H\u2082O \u2192 NADPH \u2192 Calvin cycle C) NADPH \u2192 chlorophyll \u2192 Calvin cycle D) H\u2082O \u2192 photosystem I \u2192 photosystem II E) NADPH \u2192 electron transport chain \u2192 O\u2082",
        "back": "B"
    },
    {
    ...
    {
        "front": "Which of the following does not occur during the Calvin cycle? A) carbon fixation B) oxidation of NADPH C) release of oxygen D) regeneration of the CO\u2082 acceptor E) consumption of ATP",
        "back": "C"
    },
    {
        "front": "In mechanism, photophosphorylation is most similar to A) substrate-level phosphorylation in glycolysis. B) oxidative phosphorylation in cellular respiration. C) the Calvin cycle. D) carbon fixation. E) reduction of NADP\u207a.",
        "back": "B"
    },
    {
        "front": "Which process is most directly driven by light energy? A) creation of a pH gradient by pumping protons across the thylakoid membrane B) carbon fixation in the stroma C) reduction of NADP\u207a molecules D) removal of electrons from chlorophyll molecules E) ATP synthesis",
        "back": "D"
    },
    {
    ...
    {
        "front": "6) Cytosine makes up 42% of the nucleotides in a sample of DNA from an organism. Approximately what percentage of the nucleotides in this sample will be thymine? A) 8% B) 16% C) 31% D) 42% E) It cannot be determined from the information provided.",
        "back": "A"
    },
    {
        "front": "7) Which of the following can be determined directly from X-ray diffraction photographs of crystallized DNA? A) the diameter of the helix B) the rate of replication C) the sequence of nucleotides D) the bond angles of the subunits E) the frequency of A vs. T nucleotides",
        "back": "A"
    },
    {
    ...
    {
        "front": "9) In an analysis of the nucleotide composition of DNA, which of the following will be found? A) A = C B) A = G and C = T C) A + C = G + T D) G + C = T + A",
        "back": "C"
    },
    {
    ...
    {
        "front": "13) An Okazaki fragment has which of the following arrangements? A) primase, polymerase, ligase B) 3' RNA nucleotides, DNA nucleotides 5' C) 5' RNA nucleotides, DNA nucleotides 3' D) DNA polymerase I, DNA polymerase III E) 5' DNA to 3'",
        "back": "C"
    },
    {
    ...
    {
        "front": "15) Which enzyme catalyzes the elongation of a DNA strand in the 5' \u2192 3' direction? A) primase B) DNA ligase C) DNA polymerase III D) topoisomerase E) helicase",
        "back": "C"
    },
    {
    ...
    {
        "front": "28) Which of the following help(s) to hold the DNA strands apart while they are being replicated? A) primase B) ligase C) DNA polymerase D) single-strand binding proteins E) exonuclease",
        "back": "D"
    },
    {
    ...
    {
        "front": "30) Which of the following would you expect of a eukaryote lacking telomerase? A) a high probability of somatic cells becoming cancerous B) production of Okazaki fragments C) inability to repair thymine dimers D) a reduction in chromosome length in gametes E) high sensitivity to sunlight",
        "back": "D"
    },
    {
        "front": "Use the following list of choices for the following question I. helicase II. DNA polymerase III III. ligase IV. DNA polymerase I V. primase   31) Which of the enzymes removes the RNA nucleotides from the primer and adds equivalent DNA nucleotides to the 3' end of Okazaki fragments? A) I B) II C) III D) IV E) V",
        "back": "D"
    },
    {
        "front": "Use the following list of choices for the following question I. helicase II. DNA polymerase III III. ligase IV. DNA polymerase I V. primase   32) Which of the enzymes separates the DNA strands during replication? A) I B) II C) III D) IV E) V",
        "back": "A"
    },
    {
        "front": "Use the following list of choices for the following question I. helicase II. DNA polymerase III III. ligase IV. DNA polymerase I V. primase   33) Which of the enzymes covalently connects segments of DNA? A) I B) II C) III D) IV E) V",
        "back": "C"
    },
    {
        "front": "Use the following list of choices for the following question I. helicase II. DNA polymerase III III. ligase IV. DNA polymerase I V. primase   34) Which of the enzymes synthesizes short segments of RNA? A) I B) II C) III D) IV E) V",
        "back": "E"
    },
    {
    ...
    {
        "front": "37) In a linear eukaryotic chromatin sample, which of the following strands is looped into domains by scaffolding? A) DNA without attached histones B) DNA with H1 only C) the 10-nm chromatin fiber D) the 30-nm chromatin fiber E) the metaphase chromosome",
        "back": "D"
    },
    {
    ...
    {
        "front": "card image 44) In the late 1950s, Meselson and Stahl grew bacteria in a medium containing \"heavy\" nitrogen (\u00b9\u2075N) and then transferred them to a medium containing \u00b9\u2074N. Which of the results in the figure above would be expected after one round of DNA replication in the presence of \u00b9\u2074N? A) A B) B C) C D) D E) E",
        "back": "D"
    },
    {
    ...
    {
        "front": "52) In analyzing the number of different bases in a DNA sample, which result would be consistent with the base-pairing rules? A) A = G B) A + G = C + T C) A + T = G + T D) A = C E) G = T",
        "back": "B"
    },
    {
        "front": "53) The elongation of the leading strand during DNA synthesis A) progresses away from the replication fork. B) occurs in the 3' \u2192 5' direction. C) produces Okazaki fragments. D) depends on the action of DNA polymerase. E) does not require a template strand.",
        "back": "D"
    },
    {
        "front": "54) In a nucleosome, the DNA is wrapped around A) polymerase molecules. B) ribosomes. C) histones. D) a thymine dimer. E) satellite DNA.",
        "back": "C"
    },
    {
    ...
    {
        "front": "3) The host range of a virus is determined by A) the enzymes carried by the virus. B) whether its nucleic acid is DNA or RNA. C) the proteins in the host's cytoplasm. D) the enzymes produced by the virus before it infects the cell. E) the proteins on its surface and that of the host.",
        "back": "E"
    },
    {
    ...
    {
        "front": "12) Which viruses have single-stranded RNA that acts as a template for DNA synthesis? A) lytic phages B) proviruses C) viroids D) bacteriophages E) retroviruses",
        "back": "E"
    },
    {
    ...
    {
        "front": "14) Which of the following can be effective in preventing the onset of viral infection in humans? A) taking vitamins B) getting vaccinated C) taking antibiotics D) applying antiseptics E) taking nucleoside analogs that inhibit transcription",
        "back": "B"
    },
    {
        "front": "15) Which of the following describes plant virus infections? A) They can be controlled by the use of antibiotics. B) They are spread via the plasmodesmata. C) They have little effect on plant growth. D) They are seldom spread by insects. E) They can never be passed vertically.",
        "back": "B"
    },
    {
    ...
    {
        "front": "18) What are prions? A) mobile segments of DNA B) tiny molecules of RNA that infect plants C) viral DNA that has had to attach itself to the host genome D) misfolded versions of normal brain protein E) viruses that invade bacteria",
        "back": "D"
    },
    {
    ...
    {
        "front": "card image 23) Which of the three types of viruses shown above would you expect to include glycoproteins? A) I only B) II only C) III only D) I and II only E) all three",
        "back": "D"
    },
    {
        "front": "card image 24) Which of the three types of viruses shown above would you expect to include a capsid(s)? A) I only B) II only C) III only D) I and II only E) all three",
        "back": "E"
    },
    {
        "front": "card image 25) In the figure, at the arrow marked II, what enzyme(s) are being utilized? A) reverse transcriptase B) viral DNA polymerase C) host cell DNA polymerase D) host cell RNA polymerase E) host cell DNA and RNA polymerases",
        "back": "C"
    },
    {
        "front": "card image 26) In the figure, when new viruses are being assembled (IV), what mediates the assembly? A) host cell chaperones B) assembly proteins coded for by the host nucleus C) assembly proteins coded for by the viral genes D) viral RNA intermediates E) nothing; they self-assemble",
        "back": "E"
    },
    {
    ...
    {
        "front": "43) Which of the following characteristics, structures, or processes is common to both bacteria and viruses? A) metabolism B) ribosomes C) genetic material composed of nucleic acid D) cell division E) independent existence",
        "back": "C"
    },
    {
    ...
    {
        "front": "6) Why are yeast cells frequently used as hosts for cloning? A) They easily form colonies. B) They can remove exons from mRNA. C) They do not have plasmids. D) They are eukaryotic cells. E) Only yeast cells allow the gene to be cloned.",
        "back": "D"
    },
    {
        "front": "7) The DNA fragments making up a genomic library are generally contained in A) BACs. B) recombinant viral RNA. C) individual wells. D) DNA-RNA hybrids. E) radioactive eukaryotic cells.",
        "back": "A"
    },
    {
        "front": "8) Yeast artificial chromosomes contain which of the following elements? A) centromeres only B) telomeres only C) origin of replication only D) centromeres and telomeres only E) centromeres, telomeres, and an origin of replication",
        "back": "E"
    },
    {
    ...
    {
        "front": "11) A student wishes to clone a sequence of DNA of ~200 kb. Which vector would be appropriate? A) a plasmid B) a typical bacteriophage C) a BAC D) a plant virus E) a large polypeptide",
        "back": "C"
    },
    {
    ...
    {
        "front": "15) Which of the following is used to make complementary DNA (cDNA) from RNA? A) restriction enzymes B) gene cloning C) DNA ligase D) gel electrophoresis E) reverse transcriptase",
        "back": "E"
    },
    {
    ...
    {
        "front": "20) Why might a laboratory be using dideoxy nucleotides? A) to separate DNA fragments B) to clone the breakpoints of cut DNA C) to produce cDNA from mRNA D) to sequence a DNA fragment E) to visualize DNA expression",
        "back": "D"
    },
    {
    ...
    {
        "front": "25) Which of the following describes the transfer of polypeptide sequences to a membrane to analyze gene expression? A) Southern blotting B) Northern blotting C) Western blotting D) Eastern blotting E) RT-PCR",
        "back": "C"
    },
    {
        "front": "26) Which of the following uses reverse transcriptase to make cDNA followed by amplification? A) Southern blotting B) Northern blotting C) Western blotting D) Eastern blotting E) RT-PCR",
        "back": "E"
    },
    {
    ...
    {
        "front": "29) Which of the following techniques used to analyze gene function depends on the specificity of DNA base complementarity? A) Northern blotting B) use of RNAi C) in vitro mutagenesis D) in situ hybridization E) restriction fragment analysis",
        "back": "C"
    },
    {
    ...
    {
        "front": "33) Which of the following is most closely identical to the formation of twins? A) cell cloning B) therapeutic cloning C) use of adult stem cells D) embryo transfer E) organismal cloning",
        "back": "E"
    },
    {
    ...
    {
        "front": "card image 49) Which enzyme was used to produce the molecule in Figure 20.1? A) ligase B) transcriptase C) a restriction enzyme D) RNA polymerase E) DNA polymerase",
        "back": "C"
    },
    {
    ...
    {
        "front": "card image The DNA profiles that follow represent four different individuals.   51) Which of the following statements is consistent with the results? A) B is the child of A and C. B) C is the child of A and B. C) D is the child of B and C. D) A is the child of B and C. E) A is the child of C and D.",
        "back": "B"
    },
    {
        "front": "card image 52) Which of the following statements is most likely true? A) D is the child of A and C. B) D is the child of A and B. C) D is the child of B and C. D) A is the child of C and D. E) B is the child of A and C.",
        "back": "B"
    },
    {
        "front": "card image 53) Which of the following are probably siblings? A) A and B B) A and C C) A and D D) C and D E) B and D",
        "back": "D"
    },
    {
    ...
    {
        "front": "69) In recombinant DNA methods, the term vector can refer to A) the enzyme that cuts DNA into restriction fragments. B) the sticky end of a DNA fragment. C) a SNP marker. D) a plasmid used to transfer DNA into a living cell. E) a DNA probe used to identify a particular gene.",
        "back": "D"
    },
    {
    ...
    {
        "front": "72) Which of the following sequences in double-stranded DNA is most likely to be recognized as a cutting site for a restriction enzyme?   A) AAGG TTCC   B) AGTC TCAG   C) GGCC CCGG   D) ACCA TGGT   E) AAAA TTTT",
        "back": "C"
    }
];